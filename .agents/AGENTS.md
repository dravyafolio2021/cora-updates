...
## 3. Strict Name & Identity Privacy Rule
- **Zero Use of Owner Name**: NEVER use the owner's name ("Shruti" or any variation) in ANY UI mockup, form placeholder, input label, demo signature, sample table row, marketing copy, or test data.
...
## 5. Master Atomic Design System Specification
...
## 7. Parallel Execution & Task Tracking (Global Workflow Rule)
...
## 9. Local Test Environment Credentials (`http://cora.local`)
- **Login Portal URL**: `http://cora.local/workspace/login` or `http://cora.local/wp-login.php`
- **Platform Super Admin**: Email: `admin@cora.local` | Username: `cora_admin` | Password: `cora_secure_pass_123`
...
## 10. PWA & Mobile Performance Standard Operating Procedure (SOP)
...
## 11. Universal In-App Update & Asset Sync Standard Operating Procedure (SOP)
