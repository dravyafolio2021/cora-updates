...
class Cora_Dashboard_Mockup_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Cora Dashboard Mockup', 'cora-real-estate' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Content', 'cora-real-estate' ),
        ...
        $this->add_control(
            'section_label',
            [
                'label'   => esc_html__( 'Section Label', 'cora-real-estate' ),
        ...
        $this->start_controls_section(
            'section_stats',
            [
                'label' => esc_html__( 'Platform Stats', 'cora-real-estate' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'stat_1_value',
            [
                'label'   => esc_html__( 'Stat 1 Value', 'cora-real-estate' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '2,400+',
            ]
        );
        $this->add_control(
            'stat_1_label',
            [
                'label'   => esc_html__( 'Stat 1 Label', 'cora-real-estate' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'stat_2_value',
            [
                'label'   => esc_html__( 'Stat 2 Value', 'cora-real-estate' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '98%',
            ]
        );
        $this->add_control(
            'stat_2_label',
            [
                'label'   => esc_html__( 'Stat 2 Label', 'cora-real-estate' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'stat_3_value',
            [
                'label'   => esc_html__( 'Stat 3 Value', 'cora-real-estate' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '3x',
            ]
        );
        $this->add_control(
            'stat_3_label',
            [
                'label'   => esc_html__( 'Stat 3 Label', 'cora-real-estate' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->start_controls_section(
            'section_style',
            [
                'label' => esc_html__( 'Style', 'cora-real-estate' ),
