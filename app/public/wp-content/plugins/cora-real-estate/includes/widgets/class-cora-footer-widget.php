...
class Cora_Footer_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Cora Footer', 'cora-workspace' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Brand & Tagline', 'cora-workspace' ),
        ...
        $this->add_control(
            'footer_tagline',
            [
                'label'   => esc_html__( 'Tagline', 'cora-workspace' ),
        ...
        $this->add_control(
            'footer_copyright',
            [
                'label'   => esc_html__( 'Copyright Text', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        for ( $i = 1; $i <= 4; $i++ ) {
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__( "Link Column {$i}", 'cora-workspace' ),
                    'tab'   => Controls_Manager::TAB_CONTENT,
                ]
            );
            ...
            $this->add_control(
                "col_{$i}_heading",
                [
                    'label'   => esc_html__( 'Column Heading', 'cora-workspace' ),
                    'type'    => Controls_Manager::TEXT,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Social Links', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Pre-footer CTA Banner', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'show_cta_banner',
            [
                'label'        => esc_html__( 'Show CTA Banner', 'cora-workspace' ),
        ...
        $this->add_control(
            'cta_banner_heading',
            [
                'label'     => esc_html__( 'Banner Heading', 'cora-workspace' ),
                'type'      => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'cta_banner_sub',
            [
                'label'     => esc_html__( 'Banner Subtext', 'cora-workspace' ),
                'type'      => Controls_Manager::TEXT,
