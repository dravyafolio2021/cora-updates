...
class Cora_Hero_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Cora Hero', 'cora-workspace' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_badge',
            [
                'label' => esc_html__( 'Badge', 'cora-workspace' ),
        ...
        $this->add_control(
            'badge_text',
            [
                'label'       => esc_html__( 'Badge Text', 'cora-workspace' ),
        ...
        $this->add_control(
            'badge_visible',
            [
                'label'        => esc_html__( 'Show Badge', 'cora-workspace' ),
        ...
        $this->add_control(
            'headline',
            [
                'label'       => esc_html__( 'Main Headline', 'cora-workspace' ),
        ...
        $this->add_control(
            'headline_highlight',
            [
                'label'       => esc_html__( 'Highlighted Word(s)', 'cora-workspace' ),
                'description' => esc_html__( 'Wrap the word(s) to highlight in the headline.', 'cora-workspace' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => 'Real Estate',
            ]
        );
        ...
        $this->add_control(
            'subheadline',
            [
                'label'       => esc_html__( 'Sub Headline', 'cora-workspace' ),
                'type'        => Controls_Manager::TEXTAREA,
        ...
        $this->start_controls_section(
            'section_ctas',
            [
                'label' => esc_html__( 'CTA Buttons', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'primary_cta_text',
            [
                'label'   => esc_html__( 'Primary CTA Label', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'primary_cta_url',
            [
                'label'         => esc_html__( 'Primary CTA Link', 'cora-workspace' ),
        ...
        $this->add_control(
            'secondary_cta_text',
            [
                'label'   => esc_html__( 'Secondary CTA Label', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
                'default' => 'Watch Demo',
            ]
        );
        ...
        $this->add_control(
            'secondary_cta_url',
            [
                'label'         => esc_html__( 'Secondary CTA Link', 'cora-workspace' ),
                'type'          => Controls_Manager::URL,
                'placeholder'   => 'https://',
                'show_external' => true,
                'default'       => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Feature Badges', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'feature_badges',
            [
                'label'       => esc_html__( 'Badges', 'cora-workspace' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Headline Style', 'cora-workspace' ),
        ...
        $this->add_control(
            'highlight_color',
            [
                'label'     => esc_html__( 'Highlight Color', 'cora-workspace' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#18181b',
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_style_bg',
            [
                'label' => esc_html__( 'Background', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
