...
$cora_re_listings = ( in_array( $sub_page, array( 'dashboard', 'equipment', 'leads', 'bookings' ) ) ) ? get_option( 'cora_re_listings_inventory', array() ) : array();
...
$cora_financials = get_option( 'cora_re_ledger', array() );
