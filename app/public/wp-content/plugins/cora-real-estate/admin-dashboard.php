                ...
                <div class="w-full max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 select-none">
                    ...
                    <div class="bg-white/80 dark:bg-zinc-900/60 p-4 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800/40 rounded-2xl flex items-center justify-between transition-all hover:scale-[1.01] hover:shadow-xs cursor-default">
                        <div class="space-y-1 min-w-0 pr-2">
                            <span class="block text-[9px] sm:text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider truncate">Properties</span>
                            <div class="flex items-baseline gap-1.5 flex-wrap">
                                <span class="text-base sm:text-2xl font-extrabold text-zinc-900 dark:text-zinc-100 leading-none tracking-tight"><?php echo count( $cora_re_listings ); ?></span>
                        ...
                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-zinc-50 dark:bg-zinc-800/35 border border-zinc-100 dark:border-zinc-800/50 flex items-center justify-center text-zinc-650 dark:text-zinc-350 shrink-0 shadow-3xs">
                            <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2.2" fill="none" class="w-4 h-4"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/80 dark:bg-zinc-900/60 p-4 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800/40 rounded-2xl flex items-center justify-between transition-all hover:scale-[1.01] hover:shadow-xs cursor-default">
                        <div class="space-y-1 min-w-0 pr-2">
                            ...
                            <div class="flex items-baseline gap-1.5 flex-wrap">
                                <span class="text-base sm:text-2xl font-extrabold text-zinc-900 dark:text-zinc-100 leading-none tracking-tight"><?php echo count( $cora_re_leads ); ?></span>
                    ...
                    <div class="bg-white/80 dark:bg-zinc-900/60 p-4 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800/40 rounded-2xl flex items-center justify-between transition-all hover:scale-[1.01] hover:shadow-xs cursor-default">
                        <div class="space-y-1 min-w-0 pr-2">
                            <span class="block text-[9px] sm:text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider truncate">Showings</span>
                            <div class="flex items-baseline gap-1.5 flex-wrap">
                                ...
                                <span class="text-zinc-650 dark:text-zinc-450 bg-zinc-100 dark:bg-zinc-850 inline-flex items-center text-[8px] sm:text-[9px] font-bold px-1.5 py-0.5 rounded-md leading-none">Scheduled</span>
                            </div>
                        </div>
                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-zinc-50 dark:bg-zinc-800/35 border border-zinc-100 dark:border-zinc-800/50 flex items-center justify-center text-zinc-650 dark:text-zinc-350 shrink-0 shadow-3xs">
                    ...
                    <div class="bg-white/80 dark:bg-zinc-900/60 p-4 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800/40 rounded-2xl flex items-center justify-between transition-all hover:scale-[1.01] hover:shadow-xs cursor-default">
                        <div class="space-y-1 min-w-0 pr-2">
                            <span class="block text-[9px] sm:text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider truncate">Pipeline Value</span>
                            <div class="flex items-baseline gap-1.5 flex-wrap">
                                ...
                                <span class="text-zinc-650 dark:text-zinc-450 bg-zinc-100 dark:bg-zinc-850 inline-flex items-center text-[8px] sm:text-[9px] font-bold px-1.5 py-0.5 rounded-md leading-none">Negotiating</span>
                            </div>
                        </div>
                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-zinc-50 dark:bg-zinc-800/35 border border-zinc-100 dark:border-zinc-800/50 flex items-center justify-center text-zinc-655 dark:text-zinc-350 shrink-0 shadow-3xs">
