        ...
        <div class="cora-content-wrapper p-3 sm:p-5 md:p-6 max-w-full w-full flex-1 space-y-5 sm:space-y-6 min-w-0">
            ...
            <section id="cora-page-dashboard" class="cora-page-section cora-active space-y-6">
                ...
                <div class="w-full flex flex-col items-center justify-center gap-2.5 py-2 px-0 select-none" id="cora-quick-actions-bar">
                    ...
                    <div class="w-full grid grid-cols-6 gap-2 px-4 max-w-[420px] mx-auto md:max-w-none md:mx-0 md:flex md:flex-wrap md:items-center md:justify-center md:gap-2 md:w-auto">
                        ...
                        <?php if ( $is_studio ) : ?>
                            <button onclick="coraNavigateTo('bookings'); document.getElementById('cora-add-booking-btn')?.click();" class="col-span-2 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="coraNavigateTo('equipment'); window.openAddGearDrawer?.();" class="col-span-2 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="coraNavigateTo('crew-scheduler')" class="col-span-2 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="coraNavigateTo('media')" class="col-span-3 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="coraNavigateTo('invoicing')" class="col-span-3 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                        ...
                        <?php else : ?>
                            ...
                            <button onclick="coraNavigateTo('ai-assistants')" class="col-span-2 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="coraNavigateTo('leads')" class="col-span-2 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="event.stopPropagation(); window.coraOpenCommandPalette();" class="col-span-3 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
                            ...
                            <button onclick="coraNavigateTo('listings')" class="col-span-3 md:col-auto flex justify-center items-center gap-1.5 px-2 md:px-3.5 py-1.5 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-full text-[11px] font-semibold transition-all shadow-3xs cursor-pointer whitespace-nowrap shrink-0">
