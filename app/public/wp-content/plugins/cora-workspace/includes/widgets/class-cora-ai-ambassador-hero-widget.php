...
class Cora_AI_Ambassador_Hero_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Cora AI Ambassador Hero', 'cora-workspace' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__( 'General Content', 'cora-workspace' ),
        ...
        $this->add_control(
            'tag_text',
            [
                'label'       => esc_html__( 'Top Tag Text', 'cora-workspace' ),
        ...
        $this->add_control(
            'headline_main',
            [
                'label'       => esc_html__( 'Headline (Sans-serif)', 'cora-workspace' ),
                'type'        => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'headline_serif',
            [
                'label'       => esc_html__( 'Headline Highlight (Serif)', 'cora-workspace' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => "Ambassador.",
            ]
        );
        ...
        $this->start_controls_section(
            'section_features',
            [
                'label' => esc_html__( 'Feature Pills', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            'feature_label',
            [
                'label'       => esc_html__( 'Feature Label', 'cora-workspace' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => 'Feature',
            ]
        );
        ...
        $this->add_control(
            'features_list',
            [
                'label'       => esc_html__( 'Features', 'cora-workspace' ),
        ...
        $this->start_controls_section(
            'section_cta',
            [
                'label' => esc_html__( 'CTA & Trust badges', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'cta_label',
            [
                'label'   => esc_html__( 'CTA Button Label', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'cta_url',
            [
                'label'         => esc_html__( 'CTA Link', 'cora-workspace' ),
        ...
        $this->add_control(
            'cta_subtext',
            [
                'label'   => esc_html__( 'CTA Subtext', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'shopify_text',
            [
                'label'   => esc_html__( 'Shopify Badge Text', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'rating_text',
            [
                'label'   => esc_html__( 'Rating Badge Text', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '5.0 Rating',
            ]
        );
        ...
        $this->start_controls_section(
            'section_image',
            [
                'label' => esc_html__( 'Ambassador Image & Cards', 'cora-workspace' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'avatar_image',
            [
                'label'   => esc_html__( 'Choose Avatar Image', 'cora-workspace' ),
        ...
        $this->add_control(
            'card1_title',
            [
                'label'   => esc_html__( 'Card 1 Title (Top)', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'card1_value',
            [
                'label'   => esc_html__( 'Card 1 Value', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'card2_title',
            [
                'label'   => esc_html__( 'Card 2 Title (Middle)', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'card2_value',
            [
                'label'   => esc_html__( 'Card 2 Value', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'card3_title',
            [
                'label'   => esc_html__( 'Card 3 Title (Bottom)', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
                'default' => 'TURNAROUND',
            ]
        );
        $this->add_control(
            'card3_value',
            [
                'label'   => esc_html__( 'Card 3 Value', 'cora-workspace' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Colors & Background', 'cora-workspace' ),
        ...
        $this->add_control(
            'primary_color',
            [
                'label'     => esc_html__( 'Primary Text Color', 'cora-workspace' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#09090b',
                'selectors' => [
        ...
        $this->add_control(
            'accent_color',
            [
                'label'     => esc_html__( 'Accent Color (Purple)', 'cora-workspace' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#7c3aed',
                'selectors' => [
