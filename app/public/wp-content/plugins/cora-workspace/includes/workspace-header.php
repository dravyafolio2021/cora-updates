        ...
        <div class="hidden md:flex items-center justify-between border-b border-zinc-200/50 pb-5 mb-5 select-none">
            ...
            <div class="flex items-center gap-3 shrink-0">
                ...
                <div class="cora-platform-stack flex items-center select-none mr-1" style="display: flex; align-items: center;">
                    ...
                    <button onclick="<?php echo esc_attr( $args['tutorial_onclick'] ); ?>" class="group relative w-8 h-8 rounded-full border border-zinc-200 bg-white hover:bg-zinc-50 flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 hover:z-50 shadow-2xs cursor-pointer focus:outline-none" style="z-index: 1 !important; margin-left: -10px !important;">
