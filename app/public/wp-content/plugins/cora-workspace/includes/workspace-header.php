        ...
        <div class="hidden md:flex items-center justify-between border-b border-zinc-200/50 pb-5 mb-5 select-none">
            ...
            <div class="flex items-center gap-3 shrink-0">
                ...
                <div class="cora-platform-stack flex items-center select-none mr-1" style="display: flex; align-items: center;">
                    ...
                    <button type="button" class="group relative w-8 h-8 rounded-full border border-zinc-200/80 bg-white/90 opacity-40 hover:opacity-60 flex items-center justify-center transition-all duration-200 shadow-2xs cursor-default focus:outline-none select-none" style="z-index: 1 !important; margin-left: -10px !important;" onclick="if(window.coraShowToast) window.coraShowToast('Tutorial walkthrough coming soon!', 'info');">
        ...
        <div class="flex md:hidden items-center justify-between gap-3 mb-2 px-0 py-3 border-b border-zinc-200/60 bg-white select-none">
            ...
            <div class="flex items-center gap-2 shrink-0">
                ...
                <div class="cora-platform-stack flex items-center select-none mr-0.5" style="display: flex; align-items: center;">
                    ...
                    <!-- Perplexity Button -->
                    <button onclick="coraAskExternalPlatform('perplexity')" class="group relative rounded-full border border-zinc-200 bg-zinc-50/80 flex items-center justify-center text-zinc-900 transition-all duration-200 hover:-translate-y-0.5 shadow-2xs cursor-pointer focus:outline-none" style="width: 24px; height: 24px; min-width: 24px; min-height: 24px; z-index: 2 !important; margin-left: -7px !important; padding: 0 !important;">
                    ...
                    <!-- YouTube Button (Temporarily disabled while tutorials are in production) -->
                    <?php if ( ! empty( $args['tutorial_onclick'] ) ) : ?>
                    <button type="button" class="group relative rounded-full border border-zinc-200/80 bg-white/90 opacity-40 flex items-center justify-center transition-all duration-200 shadow-2xs cursor-default focus:outline-none select-none" style="width: 24px; height: 24px; min-width: 24px; min-height: 24px; z-index: 1 !important; margin-left: -7px !important; padding: 0 !important;" onclick="if(window.coraShowToast) window.coraShowToast('Tutorial walkthrough coming soon!', 'info');">
