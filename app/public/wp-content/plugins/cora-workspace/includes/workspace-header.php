        ...
        <div class="hidden md:flex items-center justify-between border-b border-zinc-200/50 pb-5 mb-5 select-none">
            ...
            <div class="flex items-center gap-3 shrink-0">
                ...
                <div class="cora-platform-stack flex items-center select-none mr-1" style="display: flex; align-items: center;">
                    <!-- ChatGPT Button -->
                    <button onclick="coraAskExternalPlatform('openai')" class="group relative w-10 h-10 rounded-full border-0 bg-emerald-50/70 hover:bg-emerald-100/50 flex items-center justify-center text-emerald-600 transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 hover:z-50 shadow-2xs cursor-pointer focus:outline-none" style="z-index: 5 !important; margin-left: 0px !important;">
                    ...
                    <!-- Claude Button -->
                    <button onclick="coraAskExternalPlatform('claude')" class="group relative w-10 h-10 rounded-full border-0 bg-amber-50/70 hover:bg-amber-100/50 flex items-center justify-center text-amber-600 transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 hover:z-50 shadow-2xs cursor-pointer focus:outline-none" style="z-index: 4 !important; margin-left: -14px !important;">
                     ...
                     <!-- Gemini Button -->
                     <button onclick="coraAskExternalPlatform('gemini')" class="group relative w-10 h-10 rounded-full border-0 bg-blue-5/70 hover:bg-blue-100/50 flex items-center justify-center text-blue-600 transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 hover:z-50 shadow-2xs cursor-pointer focus:outline-none" style="z-index: 3 !important; margin-left: -14px !important;">
                     ...
                     <!-- Perplexity Button -->
                     <button onclick="coraAskExternalPlatform('perplexity')" class="group relative w-10 h-10 rounded-full border-0 bg-zinc-50/50 hover:bg-zinc-100/80 flex items-center justify-center text-zinc-650 transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 hover:z-50 shadow-2xs cursor-pointer focus:outline-none" style="z-index: 2 !important; margin-left: -14px !important;">
                     ...
                     <button onclick="<?php echo esc_attr( $args['tutorial_onclick'] ); ?>" class="group relative w-10 h-10 rounded-full border border-zinc-200 bg-white hover:bg-zinc-50 flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 hover:z-50 shadow-2xs cursor-pointer focus:outline-none" style="z-index: 1 !important; margin-left: -14px !important;">
        ...
        <div class="flex md:hidden items-center justify-between gap-3 mb-2 px-0 py-3 border-b border-zinc-200/60 bg-white select-none">
            ...
            <div class="flex items-center gap-2.5 shrink-0">
                ...
                <div class="cora-platform-stack flex items-center select-none mr-0.5" style="display: flex; align-items: center;">
                    ...
                    <!-- YouTube Button -->
                    <?php if ( ! empty( $args['tutorial_onclick'] ) ) : ?>
                    <button onclick="<?php echo esc_attr( $args['tutorial_onclick'] ); ?>" class="group relative rounded-full border border-zinc-200 bg-white flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 shadow-2xs cursor-pointer focus:outline-none" style="width: 28px; height: 28px; min-width: 28px; min-height: 28px; z-index: 1 !important; margin-left: -8px !important; padding: 0 !important;">
