...
const STATIC_ASSETS = [
  ...
  '%%PLUGIN_URL%%assets/pwa/icon_192_staging.png?v=' + CORA_VERSION,
  '%%PLUGIN_URL%%assets/pwa/icon_512.png?v=' + CORA_VERSION,
  '%%PLUGIN_URL%%assets/pwa/icon_512_staging.png?v=' + CORA_VERSION,
  '%%PLUGIN_URL%%assets/images/cora-favicon.png?v=' + CORA_VERSION,
  '%%PLUGIN_URL%%assets/images/cora-favicon-staging.png?v=' + CORA_VERSION,
  '%%PLUGIN_URL%%assets/images/apple-touch-icon.png?v=' + CORA_VERSION,
  '%%PLUGIN_URL%%assets/images/apple-touch-icon-staging.png?v=' + CORA_VERSION,
