...
window.CORA_TEMPLATES_ALL = [
    ...
    // Professional Services & Advisory Firm Templates (SAC 998311)
    { id: 'tpl_prof_msa', category: 'contract', style: 'professional', name: 'Professional Master Services Agreement (MSA)', amount: 250000, type: 'Contract', desc: 'Formal Master Consulting Agreement covering engagement terms, confidentiality, indemnification, and IP assignment.', items: [ { desc: 'Corporate Advisory & Strategic Consulting Master Retainer', sac: '998311', qty: 1, rate: 250000, tax: 18 } ] },
    { id: 'tpl_prof_sow', category: 'service_agreement', style: 'professional', name: 'Diagnostic Audit & Scope of Work (SOW)', amount: 175000, type: 'Service Agreement', desc: 'Detailed Statement of Work outlining diagnostic milestones, executive board deliverables, and SLA timelines.', items: [ { desc: 'Enterprise Systems & Operational Diagnostic Audit Mandate', sac: '998311', qty: 1, rate: 175000, tax: 18 } ] },
    { id: 'tpl_prof_retainer_inv', category: 'invoice', style: 'professional', name: 'Advisory Retainer Tax Invoice (SAC 9983)', amount: 200000, type: 'Invoice', desc: 'Official professional services tax invoice with SAC 998311 statutory CGST/SGST/IGST breakdown and UPI collection.', items: [ { desc: 'Monthly Strategic Advisory & Governance Retainer', sac: '998311', qty: 1, rate: 200000, tax: 18 } ] },
    { id: 'tpl_prof_proposal', category: 'proposal', style: 'professional', name: 'Executive Advisory Mandate Proposal', amount: 350000, type: 'Proposal', desc: 'C-Suite advisory proposal outlining organizational roadmap, transformation objectives, and milestone fees.', items: [ { desc: 'Executive Transformation & Advisory Mandate Phase I', sac: '998311', qty: 1, rate: 350000, tax: 18 } ] }
];
