...
$forms_header_args = array(
    ...
    'tabs'             => array(
        array(
            ...
            'badge'        => ( $total_forms_cnt > 0 ? '<span class="ml-1 px-1.5 py-0.5 bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 text-[9px] font-bold rounded-full">' . esc_html( $total_forms_cnt ) . '</span>' : '' ),
            'active'       => true,
        ...
        array(
            ...
            'icon'         => '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="1.8" fill="none" class="shrink-0"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>',
            'badge'        => '<span class="ml-1 px-1.5 py-0.5 bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 text-[9px] font-bold rounded-full">CRM</span>',
            'active'       => false,
        ...
        array(
            ...
            'icon'         => '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="1.8" fill="none" class="shrink-0"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>',
            'active'       => false,
