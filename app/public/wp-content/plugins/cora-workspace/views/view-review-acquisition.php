...
<div id="cora-reviews-feedback-wrapper" class="space-y-3.5 font-sans text-zinc-900 relative">    <!-- 4 KPI Metrics Cards Grid — 2x2 Grid on Mobile, 4 Columns on Desktop -->
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3.5">
        ...
        <div class="bg-blue-50/60 border border-blue-100 rounded-2xl p-2.5 sm:p-4 space-y-1 sm:space-y-2 relative overflow-hidden shadow-2xs">
            <div class="flex items-center justify-between gap-1">
                <span class="text-[10px] sm:text-xs font-bold text-blue-900 truncate">Total Requests Sent</span>
                <div class="w-5 h-5 sm:w-7 sm:h-7 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <div>
                <div class="text-lg sm:text-2xl font-extrabold text-zinc-950 font-mono tracking-tight"><?php echo $total_requests; ?></div>
            </div>
            <div class="h-1 rounded-full bg-blue-200/80 overflow-hidden hidden sm:block">
        ...
        <div class="bg-emerald-50/60 border border-emerald-100 rounded-2xl p-2.5 sm:p-4 space-y-1 sm:space-y-2 relative overflow-hidden shadow-2xs">
            <div class="flex items-center justify-between gap-1">
                <span class="text-[10px] sm:text-xs font-bold text-emerald-900 truncate">Google 5-Star Reviews</span>
                <div class="w-5 h-5 sm:w-7 sm:h-7 rounded-lg bg-white flex items-center justify-center shrink-0 p-0.5 shadow-2xs border border-emerald-100 ">
            ...
            <div>
                <div class="text-lg sm:text-2xl font-extrabold text-emerald-600 font-mono tracking-tight"><?php echo $google_reviews; ?></div>
            </div>
            <div class="h-1 rounded-full bg-emerald-200/80 overflow-hidden hidden sm:block">
        ...
        <div class="bg-amber-50/60 border border-amber-100 rounded-2xl p-2.5 sm:p-4 space-y-1 sm:space-y-2 relative overflow-hidden shadow-2xs">
            <div class="flex items-center justify-between gap-1">
                <span class="text-[10px] sm:text-xs font-bold text-amber-900 truncate">Private Shield Intercepts</span>
                <div class="w-5 h-5 sm:w-7 sm:h-7 rounded-lg bg-amber-100 text-amber-600 flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <div>
                <div class="text-lg sm:text-2xl font-extrabold text-amber-600 font-mono tracking-tight"><?php echo $private_intercepts; ?></div>
            </div>
            <div class="h-1 rounded-full bg-amber-200/80 overflow-hidden hidden sm:block">
        ...
        <div class="bg-purple-50/60 border border-purple-100 rounded-2xl p-2.5 sm:p-4 space-y-1 sm:space-y-2 relative overflow-hidden shadow-2xs">
            <div class="flex items-center justify-between gap-1">
                <span class="text-[10px] sm:text-xs font-bold text-purple-900 truncate">Overall Score Impact</span>
                <div class="w-5 h-5 sm:w-7 sm:h-7 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <div>
                <div class="text-lg sm:text-2xl font-extrabold text-zinc-950 font-mono tracking-tight"><?php echo $avg_rating; ?> <span class="text-[10px] text-zinc-400 font-normal">/ 5.0</span></div>
            </div>
            <div class="h-1 rounded-full bg-purple-200/80 overflow-hidden hidden sm:block">
    ...
    <div class="bg-white border border-zinc-200/80 rounded-2xl p-1.5 shadow-2xs mb-4 sm:mb-5">
        <!-- Mobile 2-Column Tab Grid (Zero Horizontal Scrollbar) -->
        <div class="grid grid-cols-2 gap-1.5 sm:hidden">
            <button type="button" onclick="coraSwitchReviewTab('tracker')" id="rev-tab-btn-tracker-mob" class="p-2 rounded-xl text-xs font-bold bg-zinc-950 text-white cursor-pointer transition-all flex items-center justify-center gap-1.5 text-center">
            ...
            <button type="button" onclick="coraSwitchReviewTab('snippets')" id="rev-tab-btn-snippets-mob" class="p-2 rounded-xl text-xs font-bold text-zinc-600 bg-zinc-50 border border-zinc-200/60 cursor-pointer transition-all flex items-center justify-center gap-1.5 text-center">
            ...
            <button type="button" onclick="coraSwitchReviewTab('automation')" id="rev-tab-btn-automation-mob" class="p-2 rounded-xl text-xs font-bold text-zinc-600 bg-zinc-50 border border-zinc-200/60 cursor-pointer transition-all flex items-center justify-center gap-1.5 text-center">
            ...
            <button type="button" onclick="coraSwitchReviewTab('reports')" id="rev-tab-btn-reports-mob" class="p-2 rounded-xl text-xs font-bold text-zinc-600 bg-zinc-50 border border-zinc-200/60 cursor-pointer transition-all flex items-center justify-center gap-1.5 text-center">
        ...
        <div class="hidden sm:flex items-center gap-1 overflow-x-auto">
            <button type="button" onclick="coraSwitchReviewTab('tracker')" id="rev-tab-btn-tracker" class="px-3.5 py-1.5 rounded-lg text-xs font-bold bg-zinc-950 text-white cursor-pointer transition-all shrink-0 flex items-center gap-1.5">
            ...
            <button type="button" onclick="coraSwitchReviewTab('snippets')" id="rev-tab-btn-snippets" class="px-3.5 py-1.5 rounded-lg text-xs font-bold text-zinc-600 hover:bg-zinc-100 cursor-pointer transition-all shrink-0 flex items-center gap-1.5">
            ...
            <button type="button" onclick="coraSwitchReviewTab('automation')" id="rev-tab-btn-automation" class="px-3.5 py-1.5 rounded-lg text-xs font-bold text-zinc-600 hover:bg-zinc-100 cursor-pointer transition-all shrink-0 flex items-center gap-1.5">
            ...
            <button type="button" onclick="coraSwitchReviewTab('reports')" id="rev-tab-btn-reports" class="px-3.5 py-1.5 rounded-lg text-xs font-bold text-zinc-600 hover:bg-zinc-100 cursor-pointer transition-all shrink-0 flex items-center gap-1.5">
    ...
    <!-- ═════════════════════════════════════════════════════════════════════
         ...
         ═════════════════════════════════════════════════════════════════════ -->
    <div id="cora-rev-panel-tracker" class="cora-shopify-card space-y-4 p-0 sm:p-4 bg-transparent sm:bg-white border-0 sm:border border-zinc-200 shadow-none sm:shadow-2xs">
        <!-- Top Title & Filter Bar -->
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-1">
            <div class="space-y-1">
                <h3 class="text-base sm:text-lg font-extrabold text-zinc-950 m-0 tracking-tight">Review Acquisition Audit Feed</h3>
                <p class="text-xs text-zinc-500 m-0 leading-relaxed">Auto-routes 4–5★ to Google Business and intercepts 1–3★ feedback into private tickets.</p>
            </div>

            <!-- Category Filter Pills (Wrap cleanly without cutoffs) -->
            <div class="flex items-center gap-1.5 flex-wrap pt-0.5 sm:pt-0">
                <button type="button" onclick="coraFilterReviewFeed('all')" id="rev-filter-all" class="px-3 py-1 rounded-full text-xs font-bold bg-zinc-950 text-white cursor-pointer shadow-2xs transition-all shrink-0">All (<?php echo $total_requests; ?>)</button>
                <button type="button" onclick="coraFilterReviewFeed('published')" id="rev-filter-published" class="px-3 py-1 rounded-full text-xs font-bold bg-zinc-100 text-zinc-700 hover:bg-zinc-200 cursor-pointer transition-all shrink-0">5-Star Published</button>
                <button type="button" onclick="coraFilterReviewFeed('intercepted')" id="rev-filter-intercepted" class="px-3 py-1 rounded-full text-xs font-bold bg-zinc-100 text-zinc-700 hover:bg-zinc-200 cursor-pointer transition-all shrink-0">Private Intercepts</button>
            </div>
        </div>

        <!-- DESKTOP TABLE VIEW (Hidden on Mobile) -->
        <div class="hidden sm:block border border-zinc-200/80 rounded-xl overflow-hidden shadow-2xs bg-white ">
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse text-xs min-w-[720px]">
                    ...
                    <tbody class="divide-y divide-zinc-100 " id="cora-review-feed-tbody">
                        <?php foreach ( $cora_review_requests as $req ) : 
                            ...
                            $status_bg = $is_private ? 'bg-amber-50 text-amber-700 border border-amber-200/70 ' : 'bg-emerald-50 text-emerald-700 border border-emerald-200/70 ';
                            $status_label = $is_private ? 'Private Shield Intercepted' : 'Google 5-Star Published';
                            $initial = strtoupper( substr( $req['client_name'], 0, 1 ) );
                            $avatar_bg = $is_private ? 'bg-amber-100 text-amber-700 ' : 'bg-blue-100 text-blue-700 ';
                            $channel_type = strtolower( $req['channel'] ?? 'whatsapp' );
                        ?>
                        <tr class="hover:bg-zinc-50/70 transition-colors <?php echo $filter_class; ?>">
                            ...
                            <td class="py-2.5 px-3 align-middle">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="space-y-0 truncate">
                                        <div class="font-bold text-xs text-zinc-900 truncate leading-tight"><?php echo esc_html( $req['client_name'] ); ?></div>
                            ...
                            <!-- CATEGORY -->
                            <td class="py-2.5 px-3 align-middle font-medium text-xs text-zinc-700 ">
                            ...
                            <td class="py-2.5 px-3 align-middle">
                                <?php if ( ! $is_private ) : ?>
                                    <span class="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/70 inline-flex items-center gap-1.5 whitespace-nowrap shadow-2xs">
                                ...
                                <?php else : ?>
                                    <span class="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-50 text-amber-700 border border-amber-200/70 inline-flex items-center gap-1.5 whitespace-nowrap shadow-2xs">
                            ...
                            <!-- REVIEW SNIPPET / NOTE -->
                            <td class="py-2.5 px-3 align-middle text-zinc-600 leading-snug text-xs" title="<?php echo esc_attr( $req['review_text'] ); ?>">
                            ...
                            <td class="py-2.5 px-3 align-middle text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <?php else : ?>
                                        ...
                                        <button type="button" onclick="coraCopyGoogleReviewUrl()" class="w-7 h-7 rounded-full bg-white hover:bg-zinc-50 border border-zinc-200 text-zinc-700 flex items-center justify-center transition-all cursor-pointer shadow-sm shrink-0" title="Copy Google Business Review Link">
                                    ...
                                    <?php endif; ?>
                                    <button type="button" onclick="coraDeleteReviewRequest('<?php echo esc_js( $req['id'] ); ?>')" class="w-7 h-7 rounded-full bg-white hover:bg-red-50 border border-zinc-200 text-zinc-400 hover:text-red-500 flex items-center justify-center transition-all cursor-pointer shadow-2xs shrink-0" title="Delete Review Entry">
        ...
        <div class="block sm:hidden space-y-2.5" id="cora-review-feed-cards">
            <?php foreach ( $cora_review_requests as $req ) : 
                ...
                $channel_type = strtolower( $req['channel'] ?? 'whatsapp' );
            ?>
            <div class="p-2.5 bg-white border border-zinc-200/80 rounded-xl space-y-2 shadow-2xs <?php echo $filter_class; ?>">
                ...
                <div class="flex items-start justify-between gap-2">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <div class="font-bold text-xs text-zinc-950 leading-tight"><?php echo esc_html( $req['client_name'] ); ?></div>
                ...
                <div class="p-2.5 bg-zinc-50/80 rounded-xl text-xs text-zinc-700 leading-relaxed italic">
                    “<?php echo esc_html( $req['review_text'] ); ?>”
                </div>

                <!-- Card Footer: Category + Rating + Status Pill + Actions -->
                <div class="flex items-center justify-between flex-wrap gap-2 pt-1 border-t border-zinc-100 ">
                    <div class="flex items-center gap-2 flex-wrap">
                        <span class="text-[10px] font-semibold text-zinc-500 bg-zinc-100 px-2 py-0.5 rounded-md">
                            <?php echo esc_html( $req['category'] ); ?>
                        </span>

                        <!-- Rating Badge -->
                        <span class="text-xs font-bold <?php echo $rating >= 4 ? 'text-emerald-600 ' : 'text-amber-600 '; ?>">
                    ...
                    <div class="flex items-center gap-1.5 ml-auto">
                        ...
                        <?php endif; ?>
                        <button type="button" onclick="coraDeleteReviewRequest('<?php echo esc_js( $req['id'] ); ?>')" class="w-6 h-6 rounded-lg bg-zinc-100 hover:bg-red-50 text-zinc-400 hover:text-red-500 flex items-center justify-center cursor-pointer transition-all">
        ...
        <div class="p-3 bg-zinc-50/80 border border-zinc-200/80 rounded-xl flex items-center justify-between flex-wrap gap-2 text-xs">
            ...
            <a href="#" onclick="coraSwitchReviewTab('automation'); return false;" class="text-xs font-bold text-zinc-900 hover:underline flex items-center gap-1">
    ...
    <!-- ═════════════════════════════════════════════════════════════════════
         ...
         ═════════════════════════════════════════════════════════════════════ -->
    <div id="cora-rev-panel-snippets" class="hidden cora-shopify-card space-y-3.5 p-0 sm:p-4 bg-transparent sm:bg-white border-0 sm:border border-zinc-200 shadow-none sm:shadow-2xs">
        <div class="space-y-0.5">
            <h3 class="text-base sm:text-lg font-extrabold text-zinc-900 m-0 tracking-tight">AI Review Snippet Generator</h3>
            <p class="text-[11px] sm:text-xs text-zinc-500 m-0">Clients hate typing long reviews! Pre-generate custom 5-star review snippets that clients can copy and post to Google in 1 tap.</p>
        </div>

        <!-- 3 Presets -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            <div class="p-3.5 sm:p-4 border border-zinc-200/80 rounded-2xl bg-white space-y-2.5 shadow-2xs hover:border-zinc-300 transition-all">
                <div class="flex items-center justify-between">
                    <span class="px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 border border-blue-200/60 text-[10px] font-bold">STUDIO PHOTOGRAPHY</span>
                    <button type="button" onclick="coraCopySnippet(1)" class="text-xs font-bold text-zinc-600 hover:text-zinc-950 cursor-pointer flex items-center gap-1">
                ...
                <p id="snippet-text-1" class="text-xs text-zinc-800 italic leading-relaxed m-0">
            ...
            <div class="p-3.5 sm:p-4 border border-zinc-200/80 rounded-2xl bg-white space-y-2.5 shadow-2xs hover:border-zinc-300 transition-all">
                <div class="flex items-center justify-between">
                    <span class="px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700 border border-emerald-200/60 text-[10px] font-bold">REAL ESTATE MEDIA</span>
                    <button type="button" onclick="coraCopySnippet(2)" class="text-xs font-bold text-zinc-600 hover:text-zinc-950 cursor-pointer flex items-center gap-1">
                        <svg viewBox="0 0 24 24" width="11" height="11" stroke="currentColor" stroke-width="2" fill="none"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                        Copy
                    </button>
                </div>
                <p id="snippet-text-2" class="text-xs text-zinc-800 italic leading-relaxed m-0">
            ...
            <div class="p-3.5 sm:p-4 border border-zinc-200/80 rounded-2xl bg-white space-y-2.5 shadow-2xs hover:border-zinc-300 transition-all">
                <div class="flex items-center justify-between">
                    <span class="px-2 py-0.5 rounded-md bg-amber-50 text-amber-700 border border-amber-200/60 text-[10px] font-bold">REAL ESTATE BROKERAGE</span>
                    <button type="button" onclick="coraCopySnippet(3)" class="text-xs font-bold text-zinc-600 hover:text-zinc-950 cursor-pointer flex items-center gap-1">
                        <svg viewBox="0 0 24 24" width="11" height="11" stroke="currentColor" stroke-width="2" fill="none"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                        Copy
                    </button>
                </div>
                <p id="snippet-text-3" class="text-xs text-zinc-800 italic leading-relaxed m-0">
        ...
        <div class="relative border border-zinc-200/80 rounded-2xl overflow-hidden bg-zinc-50/70 p-4 sm:p-5 space-y-3">
            <!-- Custom AI Generator Form Elements -->
            <div class="space-y-2.5">
                <div class="flex items-center justify-between">
                    <h4 class="text-xs font-bold text-zinc-900 m-0">Generate Custom AI Snippet</h4>
                    <span class="px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200/60 text-[10px] font-bold">Coming Soon</span>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <input type="text" id="custom-ai-client-name" placeholder="Client Name (e.g. Rahul Kapoor)" class="w-full px-3 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-sans text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                    <input type="text" id="custom-ai-service" placeholder="Key Highlight (e.g. Fast turnaround, great lighting)" class="w-full px-3 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-sans text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                </div>
                <button type="button" onclick="coraGenerateCustomAISnippet()" class="h-9 px-4 bg-zinc-950 hover:bg-zinc-800 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 cursor-pointer transition-all active:scale-97">
                    <svg viewBox="0 0 24 24" width="13" height="13" stroke="currentColor" stroke-width="2" fill="none"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                    <span>Generate AI Review Snippet</span>
                </button>
            </div>
            <div id="custom-ai-snippet-output" class="hidden p-3 bg-white border border-zinc-200 rounded-xl text-xs font-mono text-zinc-800 "></div>
        </div>
    </div>
    ...
    <!-- ═════════════════════════════════════════════════════════════════════
         ...
         ═════════════════════════════════════════════════════════════════════ -->
    <form id="cora-rev-panel-automation" class="hidden cora-shopify-card space-y-3.5 max-w-4xl p-0 sm:p-4 bg-transparent sm:bg-white border-0 sm:border border-zinc-200 shadow-none sm:shadow-2xs" onsubmit="event.preventDefault();">
        ...
        <div class="p-3 bg-[#25D366]/10 border border-[#25D366]/30 rounded-xl flex items-start gap-2.5 text-xs">
            ...
            <div class="space-y-0.5">
                <div class="font-bold text-zinc-950 flex items-center gap-1.5 text-xs">
                    <span>WhatsApp-First Strategy for Indian Businesses</span>
                </div>
                <p class="text-zinc-600 leading-snug m-0 text-[11px]">
        ...
        <div class="space-y-0.5">
            <h3 class="text-base sm:text-lg font-extrabold text-zinc-900 m-0 flex items-center gap-3 tracking-tight">
                Multi-Channel Automation Triggers
                <span id="cora-rev-autosave-pill" class="hidden px-2 py-0.5 rounded-full text-[9px] font-bold bg-zinc-100 text-zinc-500 border border-zinc-200 transition-opacity duration-300 inline-flex items-center gap-1"><svg viewBox="0 0 24 24" width="10" height="10" stroke="currentColor" stroke-width="2.5" fill="none"><polyline points="20 6 9 17 4 12"></polyline></svg> Auto-saved</span>
            </h3>
            <p class="text-[11px] sm:text-xs text-zinc-500 m-0">Configure automated post-handover review requests across WhatsApp, Email, SMS, and Social channels.</p>
        </div>

        <!-- Official Google Business Review URL Card -->
        <div class="p-3 sm:p-3.5 border border-zinc-200 rounded-xl bg-zinc-50/50 space-y-2">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
                <label class="block font-semibold text-zinc-800 text-xs">Official Google Business Review URL *</label>
                <span class="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200/60 shrink-0 w-fit">Live Connected</span>
            </div>
            <div class="relative">
                <input type="text" id="cora-google-url-input" name="cora_google_business_url" value="<?php echo esc_attr( get_option( 'cora_google_review_url', 'https://g.page/r/cora_studio/review' ) ); ?>" class="w-full pl-9 pr-3.5 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-mono text-zinc-900 focus:outline-none focus:border-zinc-900 focus:ring-2 focus:ring-zinc-950/10">
        ...
        <div class="p-3 sm:p-3.5 border border-zinc-200 rounded-xl bg-zinc-50/50 space-y-2">
            <div class="flex items-center justify-between flex-wrap gap-2">
                <label class="block font-semibold text-zinc-800 text-xs">WhatsApp Automation Message (Hinglish/English)</label>
                <div class="flex items-center gap-1.5">
                    <button type="button" onclick="coraApplyHinglishPreset('hinglish_warm')" class="px-2.5 py-1 text-[10px] font-bold rounded-lg bg-zinc-200/80 text-zinc-700 hover:bg-zinc-300 transition-all cursor-pointer">Hinglish Warm</button>
                    <button type="button" onclick="coraApplyHinglishPreset('english_prof')" class="px-2.5 py-1 text-[10px] font-bold rounded-lg bg-zinc-200/80 text-zinc-700 hover:bg-zinc-300 transition-all cursor-pointer">English Prof</button>
                </div>
            </div>
            <textarea id="cora-wa-review-template" name="cora_wa_review_template" rows="3" class="w-full p-2.5 bg-white border border-zinc-200 rounded-xl text-xs font-sans text-zinc-900 focus:outline-none focus:border-zinc-900 focus:ring-2 focus:ring-zinc-950/10 leading-relaxed"><?php echo esc_textarea( get_option( 'cora_wa_msg_template', 'Namaste {client_name} ji! Thank you for choosing Cora Studio. Could you take 5 seconds to rate us on Google? Tap here to post: {review_url}' ) ); ?></textarea>
        </div>

        <!-- Email Review Request Template -->
        <div class="p-3 sm:p-3.5 border border-zinc-200 rounded-xl bg-zinc-50/50 space-y-2">
            <label class="block font-semibold text-zinc-800 text-xs">Email Review Request Template</label>
        ...
        <div class="pt-1 flex items-center gap-2">
            <input type="checkbox" id="setting-auto-trigger" checked class="rounded border-zinc-300 text-zinc-950 focus:ring-0 cursor-pointer">
            <label for="setting-auto-trigger" class="text-xs font-semibold text-zinc-800 cursor-pointer">Auto-trigger WhatsApp & Email 2 hours after project deal status is set to 'Handed Over' or 'Invoice Paid'</label>
        </div>

        <div class="pt-1 flex items-center gap-3">
            <button type="button" onclick="coraSaveMultiChannelRules()" class="h-9 px-5 bg-zinc-950 hover:bg-zinc-800 text-white font-bold text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shadow-sm active:scale-97">
    ...
    <!-- ═════════════════════════════════════════════════════════════════════
         ...
         ═════════════════════════════════════════════════════════════════════ -->
    <div id="cora-rev-panel-reports" class="hidden cora-shopify-card space-y-4 p-0 sm:p-4 bg-transparent sm:bg-white border-0 sm:border border-zinc-200 shadow-none sm:shadow-2xs">
        <div class="space-y-0.5">
            <h3 class="text-base sm:text-lg font-extrabold text-zinc-900 m-0 tracking-tight">Automated Performance & Sentiment Reports</h3>
            <p class="text-[11px] sm:text-xs text-zinc-500 m-0">Track conversion rates, public review surges, and automated PDF/Email digest schedules.</p>
        </div>

        <!-- 3 Metric Summary Cards -->
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <div class="p-4 sm:p-4.5 bg-white border border-zinc-200/80 rounded-2xl shadow-2xs hover:border-zinc-300 transition-all space-y-1.5">
                <div class="flex items-center justify-between">
                    <span class="px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 border border-blue-200/60 text-[10px] font-extrabold uppercase tracking-wider">Conversion Rate</span>
                ...
                <div class="text-2xl sm:text-3xl font-extrabold text-zinc-950 font-mono tracking-tight"><?php echo $report_conv_rate; ?>%</div>
            ...
            <div class="p-4 sm:p-4.5 bg-white border border-zinc-200/80 rounded-2xl shadow-2xs hover:border-zinc-300 transition-all space-y-1.5">
                <div class="flex items-center justify-between">
                    <span class="px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700 border border-emerald-200/60 text-[10px] font-extrabold uppercase tracking-wider">Sentiment Index</span>
                ...
                <div class="text-2xl sm:text-3xl font-extrabold text-emerald-600 font-mono tracking-tight"><?php echo $positive_pct; ?>% Positive</div>
                <div class="text-[11px] text-zinc-500 "><?php echo $neutral_pct; ?>% Neutral · <?php echo $negative_pct; ?>% Risk Intercepted</div>
            </div>

            <div class="p-4 sm:p-4.5 bg-white border border-zinc-200/80 rounded-2xl shadow-2xs hover:border-zinc-300 transition-all space-y-1.5">
                <div class="flex items-center justify-between">
                    <span class="px-2 py-0.5 rounded-md bg-purple-50 text-purple-700 border border-purple-200/60 text-[10px] font-extrabold uppercase tracking-wider">Email Digest</span>
                ...
                <div class="text-2xl sm:text-3xl font-extrabold text-zinc-950 tracking-tight">Weekly Digest</div>
                <div class="text-[11px] text-zinc-500 truncate">Delivered to <?php echo esc_html( get_option( 'admin_email' ) ); ?></div>
            </div>
        </div>

        <!-- Custom Report Generator Box -->
        <div class="relative border border-zinc-200/80 rounded-2xl overflow-hidden bg-zinc-50/70 p-4 sm:p-5">
            <div class="flex items-center justify-between flex-wrap gap-3">
                <div>
                    <h4 class="text-xs font-bold text-zinc-900 m-0">Generate Instant Performance Report</h4>
                    <p class="text-[11px] text-zinc-500 m-0">Compile full review audit log into a clean report summary.</p>
                </div>
                <button type="button" onclick="coraGenerateReviewReportAJAX('30days')" class="h-9 px-4 bg-zinc-950 hover:bg-zinc-800 text-white text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 cursor-pointer transition-all active:scale-97">
                    <svg viewBox="0 0 24 24" width="13" height="13" stroke="currentColor" stroke-width="2" fill="none"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
...
<div id="cora-drawer-backdrop" onclick="coraCloseAllReviewDrawers()" class="fixed inset-0 z-[9998] bg-black/60 backdrop-blur-sm transition-opacity duration-250 opacity-0 hidden cursor-pointer"></div>
...
<div id="cora-send-review-drawer" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 transition-all duration-250 opacity-0 pointer-events-none hidden">
    <div class="w-full max-w-xl bg-white border border-zinc-200/80 rounded-3xl shadow-2xl overflow-hidden relative flex flex-col max-h-[85vh] pointer-events-auto">
        
        <!-- Header & Stepper Bar (Fixed Top) -->
        <div class="p-5 border-b border-zinc-100 bg-zinc-50/50 shrink-0">
            <div class="flex items-center justify-between mb-3">
                <div>
                    <h3 class="text-base font-bold text-zinc-900 m-0 flex items-center gap-2">
                        <span>Dispatch Review Request</span>
                        <span class="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-zinc-900 text-white uppercase tracking-wider">Step Wizard</span>
                    </h3>
                    <p class="text-xs text-zinc-500 mt-0.5 m-0">Create and personalize your 5-star review collection campaign.</p>
                </div>
                <button type="button" onclick="coraCloseSendReviewDrawer()" class="p-2 rounded-xl text-zinc-400 hover:text-zinc-900 hover:bg-zinc-100 transition-all cursor-pointer">
            ...
            <div class="grid grid-cols-3 gap-2 text-center text-[11px] font-bold">
                <div id="cora-wiz-step-pill-1" class="py-2 px-3 rounded-xl bg-zinc-950 text-white transition-all shadow-xs">
                    1. Client Details
                </div>
                <div id="cora-wiz-step-pill-2" class="py-2 px-3 rounded-xl bg-zinc-100 text-zinc-400 transition-all">
                    2. Target Attributes
                </div>
                <div id="cora-wiz-step-pill-3" class="py-2 px-3 rounded-xl bg-zinc-100 text-zinc-400 transition-all">
                    3. AI & Dispatch
                </div>
            </div>
        </div>
        ...
        <div class="p-6 flex-1 overflow-y-auto min-h-0 space-y-4 text-xs">
            ...
            <div id="cora-wiz-content-1" class="space-y-4">
                <div class="p-3 bg-blue-50/50 border border-blue-200/60 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-bold text-zinc-900 ">Step 1: Recipient Information</div>
                        <div class="text-[11px] text-zinc-500 ">Select existing client or enter new recipient details.</div>
                    </div>
                </div>

                <!-- Existing Client Quick Auto-Fill Selector -->
                <div>
                    <label class="block font-semibold text-zinc-800 mb-1">Quick Select Existing Client</label>
                    <select id="req-existing-client-select" onchange="coraAutoFillClientDetails(this)" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                ...
                <div>
                    <label class="block font-semibold text-zinc-800 mb-1">Client Full Name *</label>
                    <input type="text" id="req-client-name" placeholder="e.g. Rahul Kapoor" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label class="block font-semibold text-zinc-800 mb-1">Phone Number (WhatsApp/SMS) *</label>
                        <input type="text" id="req-client-phone" oninput="this.value = this.value.replace(/[^0-9+]/g, '')" placeholder="e.g. 9876543210" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-mono text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                        <span id="req-phone-error" class="text-[10px] text-red-500 font-semibold mt-1 hidden">Enter a valid 10-digit phone number.</span>
                    </div>

                    <div>
                        <label class="block font-semibold text-zinc-800 mb-1">Email Address</label>
                        <input type="email" id="req-client-email" placeholder="client@example.com" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                        <span id="req-email-error" class="text-[10px] text-red-500 font-semibold mt-1 hidden">Enter a valid email format.</span>
                    </div>
                </div>

                <div>
                    <label class="block font-semibold text-zinc-800 mb-1">Project Title</label>
                    <input type="text" id="req-project-title" placeholder="e.g. Studio Photography Service" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none focus:border-zinc-900 ">
                </div>

                <!-- Dynamic Category Selection Based on Industry -->
                <div>
                    <label class="block font-semibold text-zinc-800 mb-1">Project Category</label>
                    <select id="req-project-category" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none">
            ...
            <div id="cora-wiz-content-2" class="hidden space-y-4">
                <div class="p-3 bg-emerald-50/50 border border-emerald-200/60 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-bold text-zinc-900 ">Step 2: Service Highlights & Target Tags</div>
                        <div class="text-[11px] text-zinc-500 ">Select attributes to suggest to the client during review.</div>
                    </div>
                </div>

                <div>
                    <label class="block font-semibold text-zinc-800 mb-2">Preset Attribute Suggestions</label>
                    <div class="grid grid-cols-2 gap-2.5">
                        <label class="p-3.5 bg-zinc-50 hover:bg-zinc-100/80 border border-zinc-200 rounded-2xl flex items-center justify-between cursor-pointer transition-all">
                            <div class="flex items-center gap-2.5">
                                <span class="w-7 h-7 rounded-xl bg-zinc-200/70 text-zinc-700 flex items-center justify-center shrink-0">
                                ...
                                <span class="font-medium text-zinc-800 text-xs">Lighting & Framing</span>
                            </div>
                            <input type="checkbox" checked class="rounded border-zinc-300 text-zinc-950 focus:ring-0 cursor-pointer">
                        </label>

                        <label class="p-3.5 bg-zinc-50 hover:bg-zinc-100/80 border border-zinc-200 rounded-2xl flex items-center justify-between cursor-pointer transition-all">
                            <div class="flex items-center gap-2.5">
                                <span class="w-7 h-7 rounded-xl bg-amber-100/80 text-amber-600 flex items-center justify-center shrink-0">
                                ...
                                <span class="font-medium text-zinc-800 text-xs">Turnaround Speed</span>
                            </div>
                            <input type="checkbox" checked class="rounded border-zinc-300 text-zinc-950 focus:ring-0 cursor-pointer">
                        </label>
                        ...
                        <label class="p-3.5 bg-zinc-50 hover:bg-zinc-100/80 border border-zinc-200 rounded-2xl flex items-center justify-between cursor-pointer transition-all">
                            <div class="flex items-center gap-2.5">
                                <span class="w-7 h-7 rounded-xl bg-blue-100/80 text-blue-600 flex items-center justify-center shrink-0">
                                ...
                                <span class="font-medium text-zinc-800 text-xs">Team Punctuality</span>
                            </div>
                            <input type="checkbox" checked class="rounded border-zinc-300 text-zinc-950 focus:ring-0 cursor-pointer">
                        </label>
                        ...
                        <label class="p-3.5 bg-zinc-50 hover:bg-zinc-100/80 border border-zinc-200 rounded-2xl flex items-center justify-between cursor-pointer transition-all">
                            <div class="flex items-center gap-2.5">
                                <span class="w-7 h-7 rounded-xl bg-purple-100/80 text-purple-600 flex items-center justify-center shrink-0">
                                ...
                                <span class="font-medium text-zinc-800 text-xs">Post-Editing Quality</span>
                            </div>
                            <input type="checkbox" checked class="rounded border-zinc-300 text-zinc-950 focus:ring-0 cursor-pointer">
                        </label>
                    </div>
                ...
                <div class="p-3.5 bg-zinc-50 border border-zinc-200 rounded-2xl space-y-1">
                    ...
                    <p class="text-[11px] text-zinc-500 m-0 leading-relaxed">
            ...
            <div id="cora-wiz-content-3" class="hidden space-y-4">
                <div class="p-3 bg-purple-50/50 border border-purple-200/60 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-bold text-zinc-900 ">Step 3: Channel & AI Personalization</div>
                        <div class="text-[11px] text-zinc-500 ">Select dispatch channel and review invitation draft.</div>
                    </div>
                </div>

                <div>
                    <label class="block font-semibold text-zinc-800 mb-1">Dispatch Channel</label>
                    <select id="req-dispatch-channel" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none">
                ...
                <div>
                    <label class="block font-semibold text-zinc-800 mb-1">Custom Invitation Message / AI Snippet</label>
                    <textarea id="req-custom-msg" rows="3" class="w-full p-3 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none focus:border-zinc-900 font-sans">Namaste {client_name} ji! Thank you for choosing Cora Studio. Tap here to rate your experience: {review_url}</textarea>
                </div>
            </div>
        </div>

        <!-- PERMANENTLY VISIBLE STICKY FOOTER CTA BAR -->
        <div class="p-4 px-6 border-t border-zinc-200 bg-zinc-50 flex items-center justify-between shrink-0">
            <button type="button" id="cora-wiz-prev-btn" onclick="coraPrevWizardStep()" class="px-4 py-2 bg-white hover:bg-zinc-100 border border-zinc-200 rounded-xl text-xs font-bold text-zinc-800 transition-all cursor-pointer hidden">
                ← Back
            </button>
            <div class="flex items-center gap-2 ml-auto">
                <button type="button" onclick="coraCloseSendReviewDrawer()" class="px-4 py-2 text-zinc-500 hover:text-zinc-900 text-xs font-semibold cursor-pointer">
                    Cancel
                </button>
                <button type="button" id="cora-wiz-next-btn" onclick="coraNextWizardStep()" class="px-5 py-2.5 bg-zinc-950 hover:bg-zinc-800 text-white text-xs font-extrabold rounded-xl shadow-lg transition-all cursor-pointer flex items-center gap-2">
                    <span>Continue ➔</span>
                </button>
            </div>
        </div>
...
<div id="cora-private-ticket-drawer" class="fixed inset-y-0 right-0 z-[9999] w-full max-w-md bg-white border-l border-zinc-200 shadow-2xl transition-transform duration-250 translate-x-full hidden">
    <div class="flex flex-col h-full">
        <div class="p-5 border-b border-zinc-100 bg-zinc-50/50 flex items-center justify-between">
            <div>
                <h3 class="text-sm font-bold text-zinc-900 m-0">Private Reputation Ticket</h3>
                <p class="text-[11px] text-zinc-500 mt-0.5 m-0">Intercepted 1-3★ feedback resolved before Google public posting.</p>
            </div>
            <button type="button" onclick="coraClosePrivateTicketDrawer()" class="p-1.5 rounded-lg text-zinc-400 hover:text-zinc-900 cursor-pointer"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
        </div>
        ...
        <div class="p-6 flex-1 overflow-y-auto space-y-4 text-xs">
            ...
            <div class="bg-amber-50 border border-amber-200 p-4 rounded-xl space-y-2">
                <span class="text-[10px] font-bold text-amber-700 uppercase tracking-wider block">Private Feedback Shield Intercepted</span>
                <p id="ticket-feedback-text" class="text-zinc-800 font-medium leading-relaxed m-0">
                    "Photos were great but delivery was delayed by 1 day."
                </p>
            </div>

            <div>
                <label class="block font-semibold text-zinc-800 mb-1">Resolution Action Note</label>
                <textarea id="ticket-resolution-note" rows="3" placeholder="Enter resolution notes (e.g. Spoke with client, offered priority delivery next shoot)..." class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none"></textarea>
            </div>

            <div class="pt-2">
                <label class="flex items-center gap-2.5 text-xs text-zinc-800 font-semibold cursor-pointer">
                    <input type="checkbox" id="ticket-convert-public" class="rounded border-zinc-300 text-zinc-900 focus:ring-zinc-900">
                    <span>Convert to 5-Star Public Review upon resolution</span>
                </label>
            </div>
        </div>

        <div class="p-4 border-t border-zinc-100 bg-zinc-50/50 flex items-center justify-between gap-3">
            <button type="button" onclick="coraClosePrivateTicketDrawer()" class="px-4 py-2 border border-zinc-200 rounded-xl text-xs font-semibold text-zinc-700 bg-white ">Cancel</button>
...
<div id="cora-report-generator-drawer" class="fixed inset-y-0 right-0 z-[9999] w-full max-w-md bg-white border-l border-zinc-200 shadow-2xl transition-transform duration-250 translate-x-full hidden">
    <div class="flex flex-col h-full">
        <div class="p-5 border-b border-zinc-100 bg-zinc-50/50 flex items-center justify-between">
            <div>
                <h3 class="text-sm font-bold text-zinc-900 m-0">Automated Report Generator</h3>
                <p class="text-[11px] text-zinc-500 mt-0.5 m-0">Compile sentiment breakdown and automated audit reports.</p>
            </div>
            <button type="button" onclick="coraCloseReportDrawer()" class="p-1.5 rounded-lg text-zinc-400 hover:text-zinc-900 cursor-pointer"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
        </div>

        <div class="p-6 flex-1 overflow-y-auto space-y-4 text-xs">
            <div>
                <label class="block font-semibold text-zinc-800 mb-1">Report Timeframe</label>
                <select id="report-period-select" class="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs text-zinc-900 focus:outline-none">
            ...
            <div class="p-4 bg-zinc-50 border border-zinc-200 rounded-xl space-y-2">
                <span class="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Report Preview Summary</span>
                <div class="text-xs font-bold text-zinc-900 flex justify-between">
                    <span>Published 5-Star Reviews:</span>
                    <span class="font-mono text-emerald-600 "><?php echo $google_reviews; ?></span>
                </div>
                <div class="text-xs font-bold text-zinc-900 flex justify-between">
                    <span>Private Intercepts:</span>
                    <span class="font-mono text-amber-600 "><?php echo $private_intercepts; ?></span>
                </div>
            </div>
        </div>

        <div class="p-4 border-t border-zinc-100 bg-zinc-50/50 flex items-center justify-between gap-3">
            <button type="button" onclick="coraCloseReportDrawer()" class="px-4 py-2 border border-zinc-200 rounded-xl text-xs font-semibold text-zinc-700 bg-white ">Cancel</button>
            <button type="button" onclick="coraGenerateReviewReportAJAX('30_days')" class="px-5 py-2 bg-zinc-950 hover:bg-zinc-800 text-white rounded-xl text-xs font-bold transition-all cursor-pointer">Generate & Email Report</button>
        </div>
    </div>
</div>
...
window.coraRenderWizardStep = function(step) {
    ...
    [1, 2, 3].forEach(function(s) {
        ...
        if (pill) {
            if (s === step) {
                pill.className = 'py-2 px-3 rounded-xl bg-zinc-950 text-white transition-all font-bold';
            } else if (s < step) {
                pill.className = 'py-2 px-3 rounded-xl bg-emerald-100 text-emerald-800 transition-all font-bold';
            } else {
                pill.className = 'py-2 px-3 rounded-xl bg-zinc-100 text-zinc-400 transition-all font-bold';
            }
        }
    });
...
window.coraSwitchReviewTab = function(tabKey, skipStateUpdate) {
    ...
    document.querySelectorAll('[id^="rev-tab-btn-"]').forEach(function(b){
        if (b.id.indexOf('-mob') !== -1) {
            b.className = 'p-2 rounded-xl text-xs font-bold text-zinc-600 bg-zinc-50 border border-zinc-200/60 cursor-pointer transition-all flex items-center justify-center gap-1.5 text-center';
        } else {
            b.className = 'px-3.5 py-1.5 rounded-lg text-xs font-bold text-zinc-600 hover:bg-zinc-100 cursor-pointer transition-all shrink-0 flex items-center gap-1.5';
        }
    });

    var activeBtn = document.getElementById('rev-tab-btn-' + tabKey);
    if (activeBtn) {
        activeBtn.className = 'px-3.5 py-1.5 rounded-lg text-xs font-bold bg-zinc-950 text-white cursor-pointer transition-all shrink-0 flex items-center gap-1.5';
    }

    var activeMobBtn = document.getElementById('rev-tab-btn-' + tabKey + '-mob');
    if (activeMobBtn) {
        activeMobBtn.className = 'p-2 rounded-xl text-xs font-bold bg-zinc-950 text-white cursor-pointer transition-all flex items-center justify-center gap-1.5 text-center';
    }
...
window.coraFilterReviewFeed = function(type) {
    document.querySelectorAll('[id^="rev-filter-"]').forEach(function(b){
        b.className = 'px-2.5 py-1 rounded-full text-xs font-bold bg-zinc-100 text-zinc-700 hover:bg-zinc-200 cursor-pointer transition-all shrink-0';
    });
    var activeFilterBtn = document.getElementById('rev-filter-' + type);
    if (activeFilterBtn) {
        activeFilterBtn.className = 'px-2.5 py-1 rounded-full text-xs font-bold bg-zinc-950 text-white cursor-pointer shadow-2xs transition-all shrink-0';
    }
