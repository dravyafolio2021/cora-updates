    ...
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo esc_url( home_url( '/docs' ) ); ?>" class="flex items-center gap-2.5 text-zinc-950 hover:opacity-90 transition-opacity">
                <!-- SVG book icon -->
                <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" class="text-zinc-950 ">
            ...
            <span class="text-zinc-500 font-normal text-xs tracking-tight">Developer Docs</span>
            <!-- Version pill -->
            <span class="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded bg-zinc-100 border border-zinc-200 text-zinc-600 ">v2.2.1</span>
        </div>

        <!-- Center Section: Search box -->
        <div class="flex-1 max-w-sm">
            <button onclick="window.coraOpenSearchModal()" class="w-full flex items-center justify-between gap-3 px-3 py-1.5 rounded-lg border border-zinc-200 bg-zinc-50/50 hover:bg-zinc-100/50 text-zinc-400 hover:text-zinc-500 transition-all text-xs text-left cursor-pointer group focus:outline-none">
        ...
        <div class="flex items-center gap-4">
            ...
            <button onclick="coraPublicShowSection('changelog')" class="text-xs font-medium text-zinc-600 hover:text-zinc-950 transition-colors bg-transparent border-none p-0 cursor-pointer select-none">
                Changelog
            </button>
