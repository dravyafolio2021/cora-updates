...
<div id="cora-leads-module-container" class="space-y-6 select-none font-sans text-zinc-900 dark:text-zinc-100">    <!-- STANDARD PAGE HEADER -->
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 flex-wrap sm:flex-nowrap shrink-0">
            ...
            <div class="flex items-center gap-0.5 bg-zinc-100/80 dark:bg-zinc-800/80 p-1 rounded-2xl border border-zinc-200/60 dark:border-zinc-800">
                <button type="button" id="cora-top-header-activity-btn" class="px-3 py-1.5 text-xs font-semibold text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-white dark:hover:bg-zinc-900 hover:shadow-2xs rounded-xl transition-all flex items-center gap-1.5 cursor-pointer" onclick="coraSwitchLeadSubtab('activity')">
                ...
                <button type="button" id="cora-top-header-customize-cols" class="px-3 py-1.5 text-xs font-semibold text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-white dark:hover:bg-zinc-900 hover:shadow-2xs rounded-xl transition-all flex items-center gap-1.5 cursor-pointer" onclick="coraOpenManageStagesDrawer()">
                ...
                <button type="button" class="px-3 py-1.5 text-xs font-semibold text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-white dark:hover:bg-zinc-900 hover:shadow-2xs rounded-xl transition-all flex items-center gap-1.5 cursor-pointer" onclick="coraExportLeadsCSV()">
                        ...
                        <div class="cora-lead-card bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-zinc-200/80 dark:border-zinc-800 hover:translate-y-[-1px] transition-all cursor-grab active:cursor-grabbing flex flex-col gap-3 relative group"
                             ...
                             <div class="flex items-center justify-between gap-1.5 pt-2.5 border-t border-zinc-100 dark:border-zinc-800">
                                 ...
                                 <div class="flex items-center gap-1.5 shrink-0">
                                     <div class="w-6 h-6 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 flex items-center justify-center font-bold text-[9px] border border-zinc-200 dark:border-zinc-700 shadow-2xs" title="Assigned to <?php echo esc_attr( $assignee_display_name ); ?>">
                                         <?php echo esc_html( $assignee_init ); ?>
                                     </div>
                                     <button type="button" class="px-2.5 py-1.5 bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 font-bold rounded-lg text-[10px] transition-all cursor-pointer flex items-center gap-1 shrink-0 shadow-2xs hover:bg-zinc-800 dark:hover:bg-zinc-200" onclick="event.stopPropagation(); coraOpenLeadDetailDrawer('<?php echo esc_attr($lead['id']); ?>')">
                                         <span>Review</span>
...
<!-- ========================================================================= -->
<aside id="cora-lead-detail-drawer" class="cora-prospect-detail-drawer cora-side-drawer hidden collapsed fixed top-0 right-0 w-full md:w-[50vw] lg:w-[50vw] min-w-[480px] max-w-[98vw] h-full bg-white dark:bg-zinc-900 shadow-2xl z-[9999] transform translate-x-full transition-transform duration-300 ease-in-out border-l border-zinc-200 dark:border-zinc-800 flex flex-col font-sans" style="width: 50vw !important; min-width: 480px !important; max-width: 98vw !important;">
    ...
    <div class="px-5 sm:px-6 py-2.5 bg-zinc-50/70 dark:bg-zinc-950/40 border-b border-zinc-200/80 dark:border-zinc-800 shrink-0">
        <div class="overflow-x-auto no-scrollbar flex items-center gap-1 p-1 bg-zinc-200/70 dark:bg-zinc-800/80 rounded-2xl text-xs font-semibold">
            <button type="button" id="cora-lead-detail-tab-btn-overview" class="cora-lead-detail-tab-btn shrink-0 py-2 px-3 rounded-xl transition-all cursor-pointer bg-white dark:bg-zinc-900 text-zinc-950 dark:text-white font-bold shadow-xs flex items-center justify-center gap-1.5 whitespace-nowrap" onclick="coraSwitchLeadDetailTab('overview')">
            ...
            <button type="button" id="cora-lead-detail-tab-btn-automation" class="cora-lead-detail-tab-btn shrink-0 py-2 px-3 rounded-xl transition-all cursor-pointer text-zinc-500 hover:text-zinc-900 dark:hover:text-white flex items-center justify-center gap-1.5 whitespace-nowrap" onclick="coraSwitchLeadDetailTab('automation')">
            ...
            <button type="button" id="cora-lead-detail-tab-btn-checklist" class="cora-lead-detail-tab-btn shrink-0 py-2 px-3 rounded-xl transition-all cursor-pointer text-zinc-500 hover:text-zinc-900 dark:hover:text-white flex items-center justify-center gap-1.5 whitespace-nowrap" onclick="coraSwitchLeadDetailTab('checklist')">
            ...
            <button type="button" id="cora-lead-detail-tab-btn-audit" class="cora-lead-detail-tab-btn shrink-0 py-2 px-3 rounded-xl transition-all cursor-pointer text-zinc-500 hover:text-zinc-900 dark:hover:text-white flex items-center justify-center gap-1.5 whitespace-nowrap" onclick="coraSwitchLeadDetailTab('audit')">
    ...
    <div class="p-6 overflow-y-auto flex-1 space-y-5">
        ...
        <div id="cora-lead-detail-tab-overview" class="cora-lead-detail-tab-pane space-y-5 text-xs">
            ...
            <div class="p-4 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200/80 dark:border-zinc-800 shadow-2xs space-y-3.5">
                <div class="flex items-center justify-between gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-2.5">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-bold text-xs text-zinc-900 dark:text-white tracking-tight">Assigned Team Member & SLA Awareness</span>
                    </div>
                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700">
                        ...
                        <span>SLA Response Target: <strong class="text-zinc-950 dark:text-white font-extrabold" id="cora-drawer-sla-timer">18m remaining</strong></span>
                    </span>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
                    ...
                    <div>
                        <label class="block font-bold text-[11px] text-zinc-600 dark:text-zinc-400 mb-1">Direct Client Outreach</label>
                        <div class="flex items-center gap-2">
                            <a id="cora-drawer-sla-whatsapp-btn" href="#" target="_blank" class="flex-1 px-3 py-2 bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 font-bold rounded-xl text-xs hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all cursor-pointer flex items-center justify-center gap-1.5 shadow-2xs">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.67-1.616-.919-2.213-.242-.58-.487-.502-.67-.511l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c-.001 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413"/></svg>
                                <span>WhatsApp</span>
                            </a>
                            <a id="cora-drawer-sla-email-btn" href="#" target="_blank" class="flex-1 px-3 py-2 bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 font-bold rounded-xl text-xs hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all cursor-pointer flex items-center justify-center gap-1.5 shadow-2xs">
...
<!-- ========================================================================= -->
<aside id="cora-create-lead-drawer" class="cora-side-drawer hidden collapsed fixed top-0 right-0 w-full md:w-[50vw] lg:w-[50vw] min-w-[480px] max-w-[95vw] h-full bg-white dark:bg-zinc-900 shadow-2xl z-[9999] transform translate-x-full transition-transform duration-300 ease-in-out border-l border-zinc-200 dark:border-zinc-800 flex flex-col font-sans">
