...
<script>
// =========================================================================
// CORA CONTENT SUITE - UNIFIED AI CO-FOUNDER INTEGRATION
// =========================================================================
(function() {
    window.coraToggleCopilot = function(forceState) {
        if (typeof window.coraOpenAIPanel === 'function') {
            window.coraOpenAIPanel('chat');
        } else if (typeof window.coraToggleSidebar === 'function') {
