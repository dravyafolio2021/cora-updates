...
$cora_settings_tabs = array(
    ...
    'pulse'      => array(
        ...
        'desc'  => 'Business Pulse & workspace event stream',
...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-6 items-start">
    ...
    <div class="hidden lg:block lg:col-span-1 sticky top-6 max-h-[calc(100vh-80px)] overflow-y-auto cora-no-scrollbar space-y-1.5 pb-8 pr-1">
        ...
        <a href="#" onclick="window.coraSwitchSettingsTab('<?php echo esc_js( $tab_key ); ?>'); return false;" data-settings-tab="<?php echo esc_attr( $tab_key ); ?>" class="cora-settings-nav-item <?php echo $is_active ? 'active' : ''; ?>">
            <div class="<?php echo $is_active ? 'text-zinc-800 ' : 'text-zinc-400 group-hover:text-zinc-700'; ?> shrink-0">
                <?php echo $tab['icon']; ?>
            </div>
            <div class="min-w-0">
                <div class="text-[11px] font-bold leading-tight <?php echo $is_active ? 'text-zinc-900 ' : 'text-zinc-750 '; ?>"><?php echo esc_html( $tab['label'] ); ?></div>
                <div class="text-[9px] mt-0.5 truncate <?php echo $is_active ? 'text-zinc-500 ' : 'text-zinc-400 '; ?>"><?php echo esc_html( $tab['desc'] ); ?></div>
            </div>
        </a>
        <?php endforeach; ?>
    </div>
    ...
    <div class="lg:col-span-3 pb-24">
        ...
        <div id="cora-settings-panel-general" class="cora-settings-panel space-y-6 max-w-3xl <?php echo $active_tab === 'general' ? '' : 'hidden'; ?>">
            ...
            <div class="cora-shopify-card">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">General Site Configuration</h3>
            ...
            <div class="cora-shopify-card expanded">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">General Workspace Settings</h3>
        ...
        <div id="cora-settings-panel-pwd-policy" class="cora-settings-panel space-y-6 max-w-3xl <?php echo $active_tab === 'pwd-policy' ? '' : 'hidden'; ?>">
            ...
            <div class="cora-shopify-card">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">Workspace Password Policy</h3>
        ...
        <div id="cora-settings-panel-branches" class="cora-settings-panel space-y-6 max-w-3xl <?php echo $active_tab === 'branches' ? '' : 'hidden'; ?>">
            <div class="cora-shopify-card p-0 overflow-hidden">
                <div class="cora-shopify-card-header border-b border-zinc-100 p-4 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">Brokerage Branches</h3>
                                        ...
                                        <tr class="hover:bg-zinc-50/10 ">
                                            ...
                                            <td class="px-5 py-3.5 text-right">
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    <button type="button" onclick="deleteBranch('<?php echo esc_attr($b_id); ?>', <?php echo $crew_count; ?>)" class="px-2.5 py-1 border border-zinc-200 rounded-lg text-[10px] font-bold text-red-650 bg-white hover:bg-red-50 hover:border-red-200 cursor-pointer shadow-sm transition-colors">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
        ...
        <div id="cora-settings-panel-brand" class="cora-settings-panel space-y-6 max-w-3xl <?php echo $active_tab === 'brand' ? '' : 'hidden'; ?>">
            ...
            <div class="cora-shopify-card">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">Brand Assets</h3>
                ...
                <div class="p-4 border border-zinc-200 rounded-xl bg-zinc-50/50 space-y-3">
                    <label class="block text-xs font-bold text-zinc-700 ">Agency Logo</label>
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div id="cora-suite-logo-dropzone" class="w-full max-w-sm h-32 border-2 border-dashed border-zinc-200 hover:border-zinc-400 rounded-2xl bg-white flex flex-col items-center justify-center p-4 cursor-pointer transition-all group" onclick="coraOpenMediaSelector('cora-brand-logo-url-suite')">
                            ...
                            <div id="cora-suite-logo-preview" class="w-full h-full flex flex-col items-center justify-center overflow-hidden">
                                ...
                                <?php else : ?>
                                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" class="text-zinc-400 group-hover:text-zinc-650 transition-colors mb-1.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                                    <span class="text-xs font-bold text-zinc-850 ">Upload Agency Logo</span>
                                    <span class="text-[10px] text-zinc-500 mt-1">Recommended size: 250x80px (PNG/JPG)</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <!-- Control Actions -->
                        <div class="space-y-2">
                            <button type="button" class="px-3.5 py-2 bg-zinc-950 hover:bg-zinc-800 text-white font-bold text-xs rounded-xl shadow-2xs transition-all cursor-pointer flex items-center gap-1.5" onclick="coraOpenMediaSelector('cora-brand-logo-url-suite')">
                ...
                <div class="p-4 border border-zinc-200 rounded-xl bg-zinc-50/50 space-y-3">
                    <label class="block text-xs font-bold text-zinc-700 ">Custom Favicon (32x32 / 64x64 PNG)</label>
                    ...
                    <div class="flex items-center gap-5">
                        <!-- Preview Box / Upload Dropzone -->
                        <div id="cora-suite-favicon-dropzone" class="w-24 h-24 border-2 border-dashed border-zinc-200 hover:border-zinc-400 rounded-2xl bg-white flex flex-col items-center justify-center p-3 cursor-pointer transition-all group shrink-0" onclick="coraOpenMediaSelector('cora-brand-favicon-url-suite')">
                            <?php 
                            ...
                            <div id="cora-suite-favicon-preview" class="w-full h-full flex flex-col items-center justify-center overflow-hidden">
                                ...
                                <?php else : ?>
                                    <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2" fill="none" class="text-zinc-400 group-hover:text-zinc-650 transition-colors mb-1"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>
                        ...
                        <div class="space-y-1.5">
                            <div class="flex gap-2">
                                <button type="button" class="px-3 py-1.5 bg-zinc-950 hover:bg-zinc-800 text-white font-bold text-[11px] rounded-lg shadow-2xs transition-all cursor-pointer flex items-center gap-1" onclick="coraOpenMediaSelector('cora-brand-favicon-url-suite')">
                                    Choose Icon
                                </button>
                                <button type="button" class="px-3 py-1.5 bg-zinc-100 hover:bg-zinc-200 text-zinc-700 font-semibold text-[11px] rounded-lg transition-colors cursor-pointer" onclick="coraSetDefaultPremiumFavicon()">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" class="px-2.5 py-1 text-zinc-600 hover:text-zinc-850 font-semibold text-[10px] rounded transition-all cursor-pointer" onclick="if(window.coraApplyBrandingLive) window.coraApplyBrandingLive();">
                                    Apply Live
                                </button>
                            </div>
                        </div>
                ...
                <div class="cora-shopify-card">
                    <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                        <div>
                            <h3 class="text-sm font-semibold text-zinc-900 m-0">Browser Tab &amp; Sidebar Title Settings</h3>
        ...
        <div id="cora-settings-panel-reading" class="cora-settings-panel space-y-6 max-w-3xl <?php echo $active_tab === 'reading' ? '' : 'hidden'; ?>">
            ...
            <div class="flex items-center gap-3 px-4 py-3 rounded-xl border <?php echo $is_indexed ? 'bg-emerald-50/50 border-emerald-200 ' : 'bg-red-50/50 border-red-200 '; ?>">
                <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 <?php echo $is_indexed ? 'bg-emerald-100 ' : 'bg-red-100 '; ?>">
                    ...
                    <?php else : ?>
                        <svg viewBox="0 0 24 24" width="15" height="15" stroke="currentColor" stroke-width="2" fill="none" class="text-red-600 "><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                    <?php endif; ?>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-xs font-bold <?php echo $is_indexed ? 'text-emerald-800 ' : 'text-red-800 '; ?>">
                ...
                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider flex-shrink-0 whitespace-nowrap <?php echo $is_indexed ? 'bg-emerald-100 text-emerald-700 ' : 'bg-red-100 text-red-700 '; ?>"><?php echo $is_indexed ? 'Live' : 'Blocked'; ?></span>
            </div>
            ...
            <div class="cora-shopify-card">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">Homepage &amp; Blog Routing</h3>
                    ...
                    <div class="flex items-center gap-3">
                        <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-zinc-100 text-zinc-500 flex-shrink-0">
                ...
                <!-- Growth Tip -->
                <div class="flex items-start gap-2.5 p-3 bg-zinc-50 rounded-lg border border-zinc-100 ">
                    ...
                    <p class="text-[11px] text-zinc-500 leading-relaxed"><strong class="text-zinc-700 ">Growth tip:</strong> Set your homepage to a dedicated landing page with a lead capture form and property search. Agencies using a static conversion page typically see 2–3× more inquiry submissions than blog-first layouts.</p>
                </div>
                </div> <!-- close cora-shopify-card-body -->
            </div>
            ...
            <div class="cora-shopify-card">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">Search Engine Crawler Visibility</h3>
        ...
        <div id="cora-settings-panel-privacy" class="cora-settings-panel space-y-6 max-w-3xl <?php echo $active_tab === 'privacy' ? '' : 'hidden'; ?>">
            ...
            <div class="cora-shopify-card">
                <div class="cora-shopify-card-header border-b border-zinc-100 pb-3 flex items-center justify-between cursor-pointer select-none">
                    <div>
                        <h3 class="text-sm font-semibold text-zinc-900 m-0">Privacy Policy Page Assignment</h3>
        ...
        <div id="cora-settings-panel-git-sync" class="cora-settings-panel max-w-full <?php echo $active_tab === 'git-sync' ? '' : 'hidden'; ?> grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
            ...
            <div class="xl:col-span-7 space-y-6">
                ...
                <div class="cora-shopify-card">
                    <div class="cora-shopify-card-header border-b border-zinc-100 pb-4 flex items-center justify-between cursor-pointer select-none">
                        <div class="flex items-center gap-3">
                            <!-- GitHub Logo SVG (official mark) -->
                            <div class="w-9 h-9 rounded-xl bg-zinc-950 border border-zinc-800 flex items-center justify-center flex-shrink-0 shadow-sm">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-zinc-900 m-0">GitHub Connection</h3>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold whitespace-nowrap <?php echo $git_token ? 'bg-green-50 text-green-700 border border-green-200 ' : 'bg-zinc-100 text-zinc-650 border border-zinc-200 '; ?>">
                    ...
                    <?php if ( empty( $git_token ) ) : ?>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start gap-3 p-3.5 rounded-xl bg-zinc-50 border border-zinc-200 ">
                                ...
                                <p class="text-[11px] text-zinc-500 leading-relaxed">Generate a <strong class="text-zinc-700 ">Personal Access Token</strong> from <a href="https://github.com/settings/tokens" target="_blank" class="underline underline-offset-2 text-zinc-700 hover:text-zinc-900">GitHub Developer Settings</a> with <code class="text-[9px] bg-zinc-200 px-1 py-0.5 rounded font-mono">repo</code> scope enabled.</p>
                            </div>
                            <div>
                                <label class="block text-[10px] font-bold text-zinc-450 uppercase tracking-widest mb-1.5">Personal Access Token</label>
                                <input type="password" id="cora-git-token-input" placeholder="ghp_xxxxxxxxxxxxxxxxxxxx" class="w-full bg-white border border-zinc-200 rounded-xl px-3 py-2 text-xs text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-950 transition-all shadow-3xs font-mono tracking-widest" oncopy="return false;" oncut="return false;" ondragstart="return false;" ondrop="return false;" autocomplete="off">
                            </div>
                            <button type="button" onclick="coraConnectGitHub()" class="inline-flex items-center gap-2 px-4 py-2 bg-zinc-950 text-white hover:bg-zinc-800 text-xs font-bold rounded-xl transition-colors cursor-pointer shadow-3xs">
                    ...
                    <?php else : ?>
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-[10px] font-bold text-zinc-450 uppercase tracking-widest mb-1.5">GitHub Repository</label>
                                    ...
                                    <div class="relative" id="cora-git-repo-searchable-select-container" data-saved-url="<?php echo esc_url($saved_repo); ?>">
                                        <!-- Trigger -->
                                        <div id="cora-repo-select-trigger" class="flex items-center justify-between gap-2 px-3.5 py-2 text-xs bg-zinc-50 border border-zinc-200 rounded-xl cursor-pointer hover:border-zinc-300 transition-all select-none text-zinc-800 ">
                                            <div class="flex items-center gap-2 min-w-0">
                                                <svg viewBox="0 0 98 96" width="12" height="12" class="fill-zinc-500 shrink-0"><path fill-rule="evenodd" clip-rule="evenodd" d="M48.854 0C21.839 0 0 22 0 49.217c0 21.756 13.993 40.172 33.405 46.69 2.427.49 3.316-1.059 3.316-2.362 0-1.141-.08-5.052-.08-9.127-13.59 2.934-16.42-5.867-16.42-5.867-2.184-5.704-5.42-7.17-5.42-7.17-4.448-3.015.324-3.015.324-3.015 4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404 5.378 14.235 4.074.404-3.178 1.699-5.378 3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283 0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038 0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1 12.214-1.63c4.125 0 8.33.571 12.213 1.63 9.302-6.356 13.427-5.052 13.427-5.052 2.67 6.763.97 11.816.485 13.038 3.155 3.422 5.015 7.822 5.015 13.2 0 18.905-11.404 23.06-22.324 24.283 1.78 1.548 3.316 4.481 3.316 9.126 0 6.6-.08 11.897-.08 13.526 0 1.304.89 2.853 3.316 2.364 19.412-6.52 33.405-24.935 33.405-46.691C97.707 22 75.788 0 48.854 0z"/></svg>
                                                <span id="cora-repo-select-display-text" class="text-zinc-450 truncate">Loading repositories...</span>
                                            </div>
                                            <svg viewBox="0 0 24 24" width="13" height="13" stroke="currentColor" stroke-width="2.2" fill="none" id="cora-repo-select-arrow" class="text-zinc-400 shrink-0 transition-transform"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                        </div>

                                        <!-- Dropdown Panel -->
                                        <div id="cora-repo-select-dropdown" class="absolute left-0 right-0 z-[100] mt-1.5 bg-white border border-zinc-200 rounded-xl shadow-lg overflow-hidden" style="display:none;">
                                            <!-- Search -->
                                            <div class="p-2 border-b border-zinc-100 bg-zinc-50/50 ">
                                                <input type="text" id="cora-git-repo-search-input" placeholder="Search repositories..." class="w-full bg-white border border-zinc-200 rounded-lg px-2.5 py-1.5 text-xs text-zinc-900 outline-none focus:ring-1 focus:ring-zinc-950 placeholder:text-zinc-400" autocomplete="off">
                                            </div>
                                            <!-- List -->
                                            <div id="cora-repo-options-list" class="max-h-[220px] overflow-y-auto py-1 divide-y divide-zinc-50 ">
                                        ...
                                        <div id="cora-git-repo-manual-container" class="mt-2" style="display:none;">
                                            <input type="text" id="cora-git-repo-manual-input" name="cora_git_sync_repo" value="<?php echo esc_attr( $saved_repo ); ?>" placeholder="https://github.com/user/repo" class="w-full bg-white border border-zinc-200 rounded-xl px-3 py-2 text-xs text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-950 transition-all shadow-3xs">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <?php $saved_branch = get_option('cora_git_sync_branch', 'main'); ?>
                                    <label class="block text-[10px] font-bold text-zinc-450 uppercase tracking-widest mb-1.5">Branch</label>
                                    <div class="relative" id="cora-git-branch-searchable-select-container" data-saved-branch="<?php echo esc_attr($saved_branch); ?>">
                                        <!-- Trigger -->
                                        <div id="cora-branch-select-trigger" class="flex items-center justify-between gap-2 px-3.5 py-2 text-xs bg-zinc-50 border border-zinc-200 rounded-xl cursor-pointer hover:border-zinc-300 transition-all select-none text-zinc-800 ">
                                            <div class="flex items-center gap-2 min-w-0">
                                                <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.2" class="text-zinc-500 shrink-0"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>
                                                <span id="cora-branch-select-display-text" class="text-zinc-450 truncate">Select branch...</span>
                                            </div>
                                            <svg viewBox="0 0 24 24" width="13" height="13" stroke="currentColor" stroke-width="2.2" fill="none" id="cora-branch-select-arrow" class="text-zinc-400 shrink-0 transition-transform"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                        </div>
                                        <!-- Dropdown -->
                                        <div id="cora-branch-select-dropdown" class="absolute left-0 right-0 z-[100] mt-1.5 bg-white border border-zinc-200 rounded-xl shadow-lg overflow-hidden" style="display:none;">
                                            <div class="p-2 border-b border-zinc-100 bg-zinc-50/50 ">
                                                <input type="text" id="cora-git-branch-search-input" placeholder="Search branches..." class="w-full bg-white border border-zinc-250 rounded-lg px-2.5 py-1.5 text-xs text-zinc-900 outline-none focus:ring-1 focus:ring-zinc-950 placeholder:text-zinc-400" autocomplete="off">
                                            </div>
                                            <div id="cora-branch-options-list" class="max-h-[200px] overflow-y-auto py-1 divide-y divide-zinc-50 ">
                            ...
                            <button type="button" onclick="coraDisconnectGitHub()" class="inline-flex items-center gap-1.5 px-3 py-2 border border-zinc-200 hover:bg-zinc-50 text-zinc-700 text-xs font-semibold rounded-xl transition-all cursor-pointer shadow-3xs">
                ...
                <div class="cora-shopify-card">
                    <div class="cora-shopify-card-header border-b border-zinc-100 pb-4 flex items-center justify-between cursor-pointer select-none">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-zinc-900 m-0">Lovable Integration</h3>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold whitespace-nowrap <?php echo $live_url ? 'bg-green-50 text-green-700 border border-green-200 ' : 'bg-zinc-100 text-zinc-650 border border-zinc-200 '; ?>">
                    ...
                    <div class="cora-shopify-card-body pt-4 space-y-4">
                        <div class="space-y-4">
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-450 uppercase tracking-widest mb-1.5">Lovable Live URL</label>
                            <input type="text" name="cora_git_sync_live_url" id="cora-lovable-live-url" value="<?php echo esc_attr( $live_url ); ?>" placeholder="https://your-app.lovable.app" class="w-full bg-white border border-zinc-200 rounded-xl px-3 py-2 text-xs text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-950 transition-all shadow-3xs">
                        ...
                        <?php if ( ! empty( $live_url ) ) : ?>
                            <button type="button" onclick="coraDisconnectLovable()" class="inline-flex items-center gap-1.5 px-3 py-2 border border-zinc-200 hover:bg-zinc-50 text-zinc-700 text-xs font-semibold rounded-xl transition-all cursor-pointer shadow-3xs">
            ...
            <div class="xl:col-span-5 cora-shopify-card bg-zinc-50/50">
                <div class="p-5 space-y-5">
                    <div class="flex items-center gap-2.5 pb-2 border-b border-zinc-200 ">
                        <span class="text-zinc-900 shrink-0">
                            <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2.2" fill="none" class="text-zinc-500 "><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </span>
                    ...
                    <div class="space-y-5 text-xs text-zinc-700 ">
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="space-y-1">
                                <span class="font-bold text-zinc-900 ">Initiate on Lovable</span>
                                <p class="leading-relaxed">Build your real estate client site or application on <a href="https://lovable.dev" target="_blank" class="underline font-semibold text-zinc-950 hover:text-zinc-850">Lovable.dev</a> using plain English, and publish it to a GitHub repository.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="space-y-2">
                                <div>
                                    <span class="font-bold text-zinc-900 block">Generate a GitHub Token</span>
                                    <p class="leading-relaxed">If your repository is Private, generate a security token so Cora can access the code.</p>
                                </div>
                                <a href="https://github.com/settings/tokens/new?scopes=repo&description=Cora%20Git%20Sync" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-zinc-950 text-white hover:bg-zinc-800 text-[10px] font-bold rounded-xl transition-all shadow-3xs cursor-pointer">
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="space-y-1">
                                <span class="font-bold text-zinc-900 ">Connect & Sync</span>
                    ...
                    <div class="p-3.5 bg-zinc-100 rounded-xl border border-zinc-200/50 flex gap-3 mt-4">
                        <span class="text-zinc-650 shrink-0 mt-0.5">
                        ...
                        <div class="space-y-1">
                            <span class="text-[10px] font-bold text-zinc-800 uppercase tracking-wider">Dynamic Integration</span>
                            <p class="text-[10px] text-zinc-550 leading-relaxed font-medium">Cora injects `window.CORA_API_URL` and `window.CORA_NONCE` automatically. Any form submissions or CRM requests made in your Lovable code will query this site's databases dynamically.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6 max-w-4xl">
            ...
            <div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
                <div class="px-5 py-4 border-b border-zinc-100 ">
                    <h3 class="text-sm font-bold text-zinc-900 ">Registration Controls</h3>
                ...
                <div class="divide-y divide-zinc-100 ">
                    ...
                    <div class="px-5 py-3.5 flex items-center justify-between gap-4">
                        <div>
                            <div class="text-xs font-semibold text-zinc-800 "><?php echo esc_html( $toggle['label'] ); ?></div>
                        ...
                        <label class="relative inline-flex items-center cursor-pointer shrink-0">
                            ...
                            <div class="relative w-9 h-5 bg-zinc-200 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-zinc-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-zinc-950 "></div>
                        </label>
                    </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
                <div class="px-5 py-4 border-b border-zinc-100 ">
                    <h3 class="text-sm font-bold text-zinc-900 ">Account Defaults</h3>
                ...
                <div class="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="cora_onboarding_account_duration" value="<?php echo intval( $ob_duration ); ?>" min="0" placeholder="0 = Lifetime" class="w-full px-3 py-2 text-xs bg-zinc-50 border border-zinc-200 rounded-lg text-zinc-800 outline-none focus:border-zinc-400">
                    ...
                    <div>
                        ...
                        <textarea name="cora_onboarding_welcome_message" rows="2" placeholder="Welcome to the platform! Here's how to get started..." class="w-full px-3 py-2 text-xs bg-zinc-50 border border-zinc-200 rounded-lg text-zinc-800 outline-none focus:border-zinc-400 resize-none"><?php echo esc_textarea( $ob_welcome ); ?></textarea>
            ...
            <div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
                <div class="px-5 py-4 border-b border-zinc-100 flex items-center justify-between">
                    <div>
                        <h3 class="text-sm font-bold text-zinc-900 ">Self-Registered Users</h3>
                ...
                <div class="overflow-x-auto">
                    ...
                    <div class="px-5 py-8 text-center text-xs text-zinc-400">
                        No self-registered users yet. Share your registration link: <code class="text-zinc-600 "><?php echo esc_html( home_url( '/workspace/register' ) ); ?></code>
                    </div>
                    <?php else : ?>
                    <table class="w-full" id="ob-users-table">
                        ...
                        ?>
                        <tr class="hover:bg-zinc-50 transition-colors" data-uid="<?php echo $ob_u->ID; ?>">
                            <td class="px-4 py-3">
                                <div class="text-xs font-semibold text-zinc-800 "><?php echo esc_html( $ob_u->display_name ); ?></div>
                                <div class="text-[10px] text-zinc-400 mt-0.5"><?php echo esc_html( $ob_u->user_email ); ?></div>
                                <?php if ( $ob_status === 'inactive' ) : ?>
                                <span class="inline-block mt-0.5 text-[9px] font-bold bg-zinc-200 text-zinc-600 px-1.5 py-0.5 rounded">Deactivated</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-4 py-3 hidden md:table-cell">
                                <span class="text-[10px] text-zinc-600 "><?php echo esc_html( $ob_role_disp ); ?></span>
                            </td>
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button type="button" onclick="obChangeRole(<?php echo $ob_u->ID; ?>)" class="px-2 py-1 text-[10px] font-semibold bg-zinc-100 hover:bg-zinc-200 rounded text-zinc-700 transition-colors cursor-pointer">Role</button>
                                    <button type="button" onclick="obSetExpiry(<?php echo $ob_u->ID; ?>)" class="px-2 py-1 text-[10px] font-semibold bg-zinc-100 hover:bg-zinc-200 rounded text-zinc-700 transition-colors cursor-pointer">Expiry</button>
                                    <?php if ( $ob_status === 'inactive' ) : ?>
                                    <button type="button" onclick="obToggleStatus(<?php echo $ob_u->ID; ?>, 'activate')" class="px-2 py-1 text-[10px] font-semibold bg-zinc-100 hover:bg-zinc-200 rounded text-zinc-700 transition-colors cursor-pointer">Activate</button>
                                    <?php else : ?>
                                    <button type="button" onclick="obToggleStatus(<?php echo $ob_u->ID; ?>, 'deactivate')" class="px-2 py-1 text-[10px] font-semibold bg-zinc-100 hover:bg-zinc-200 rounded text-zinc-700 transition-colors cursor-pointer">Deactivate</button>
                                    <?php endif; ?>
            ...
            <div class="p-4 bg-zinc-50 rounded-xl border border-zinc-200 flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-[10px] font-bold text-zinc-600 uppercase tracking-widest mb-0.5">Registration Link</div>
                    <code class="text-[11px] text-zinc-700 truncate block"><?php echo esc_html( home_url( '/workspace/register' ) ); ?></code>
                </div>
                <button type="button" onclick="navigator.clipboard.writeText('<?php echo esc_js( home_url( '/workspace/register' ) ); ?>').then(function(){ window.coraShowToast('Link copied!'); })" class="shrink-0 px-3 py-1.5 bg-zinc-900 text-white text-[10px] font-bold rounded-lg cursor-pointer hover:opacity-80 transition-opacity">Copy</button>
            </div>
        </div>
        ...
        <div id="cora-settings-panel-updates" class="cora-settings-panel space-y-6 max-w-3xl relative <?php echo $active_tab === 'updates' ? '' : 'hidden'; ?>">
            <div class="cora-shopify-card">
                ...
                <div class="cora-shopify-card-header border-b border-zinc-150 pb-3 flex items-center justify-between">
                    <div>
                        <h3 class="text-sm font-bold text-zinc-900 m-0">Software Updates</h3>
                        <p class="text-xs text-zinc-500 m-0">Manage system versions, release channels, and automated feature shipments.</p>
                    </div>
                    <div class="relative hidden sm:block">
                        <span class="inline-flex items-center gap-2 px-3 py-1.5 border border-zinc-200 rounded-xl bg-zinc-50 text-xs font-bold text-zinc-700 select-none">
                ...
                <div class="cora-shopify-card-body pt-5 relative">
                    ...
                    <div id="cora-updates-status-container" class="select-none mb-5">
                        ...
                        <div id="cora-updates-state-uptodate" class="<?php echo $update_available ? 'hidden' : ''; ?> p-5 bg-zinc-50 border border-zinc-200 rounded-2xl flex items-start gap-4">
                            <div class="w-10 h-10 rounded-xl bg-emerald-500/10 text-emerald-600 flex items-center justify-center shrink-0 border border-emerald-500/20 shadow-3xs">
                            ...
                            <div class="space-y-1">
                                <h4 class="text-xs font-bold text-zinc-900 m-0 flex items-center gap-2">
                                    ...
                                    <span class="px-2 py-0.5 rounded-md text-[10px] font-mono bg-emerald-500/15 text-emerald-700 font-bold border border-emerald-500/20">v<?php echo esc_html( CORA_WORKSPACE_VERSION ); ?></span>
                                </h4>
                                <p class="text-xs text-zinc-600 m-0 font-medium leading-relaxed">
                        ...
                        <div id="cora-updates-state-checking" class="hidden p-4 bg-zinc-50 border border-zinc-200 rounded-xl flex items-center gap-3">
                            <div class="w-9 h-9 rounded-xl bg-zinc-200 text-zinc-600 flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <h4 class="text-xs font-bold text-zinc-900 m-0">Checking for Updates...</h4>
                                <p class="text-[11px] text-zinc-500 mt-0.5 m-0">Connecting to secure release shipment server.</p>
                            </div>
                        </div>
                        ...
                        <div id="cora-updates-state-available" class="<?php echo $update_available ? '' : 'hidden'; ?> w-full text-left animate-in fade-in duration-200">
                            <div class="border border-emerald-500/30 rounded-2xl p-5 bg-gradient-to-br from-emerald-500/5 via-emerald-500/10 to-transparent space-y-3.5 shadow-xs">
                                    ...
                                    <div class="flex items-center gap-3.5">
                                        ...
                                        <div>
                                            <div class="flex items-center gap-2 flex-wrap">
                                                ...
                                                <span class="text-sm font-black text-zinc-900 font-mono" id="cora-avail-ver-pill">v<?php echo esc_html( $info['version'] ?? CORA_WORKSPACE_VERSION ); ?></span>
                                            </div>
                                            <p class="text-xs text-zinc-600 mt-1 m-0">
                                                Upgrade from <span class="font-semibold text-zinc-800 ">v<?php echo esc_html( CORA_WORKSPACE_VERSION ); ?></span> to <span class="font-bold text-emerald-600 font-mono" id="cora-avail-target-ver">v<?php echo esc_html( $info['version'] ?? CORA_WORKSPACE_VERSION ); ?></span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div id="cora-avail-highlights-box" class="space-y-2 pt-1">
                                    <h5 class="text-[11px] font-bold uppercase tracking-wider text-emerald-800 m-0 flex items-center gap-1.5">
                                    ...
                                    <div id="cora-avail-highlights-content" class="text-xs text-zinc-700 space-y-1.5 m-0 font-medium">
                                        <?php
                        ...
                        <div id="cora-updates-state-progress" class="hidden w-full text-left space-y-3 animate-in fade-in duration-200">
                            <div class="p-4 bg-zinc-50 rounded-xl border border-zinc-150 space-y-3">
                                <div class="flex items-center justify-between text-xs">
                                    <span class="font-bold text-zinc-900 flex items-center gap-2">
                                    ...
                                    <span class="font-bold text-zinc-900 " id="cora-upgrade-percent-text">0%</span>
                                </div>
                                <div class="h-2 w-full bg-zinc-200 rounded-full overflow-hidden">
                                    <div id="cora-upgrade-progress-bar" class="h-full bg-zinc-950 w-0 transition-all duration-350 ease-out rounded-full"></div>
                                </div>
                        ...
                        <!-- State: Error State -->
                        <div id="cora-updates-state-error" class="hidden space-y-2 p-4 bg-red-500/5 border border-red-200 rounded-xl">
                            <h4 class="text-xs font-bold text-red-600 m-0">Connection Failed</h4>
                    ...
                    <div id="cora-settings-changelog-section" class="<?php echo $update_available ? '' : 'hidden'; ?> space-y-3 pt-2">
                        <div class="flex items-center justify-between border-b border-zinc-150 pb-2.5">
                            <h4 class="text-xs font-bold text-zinc-900 uppercase tracking-wider m-0">Changelog & Features</h4>
                            <button type="button" id="cora-settings-expand-btn" onclick="coraToggleSettingsExpandAll(this);" class="h-7 px-3 border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-750 rounded-lg text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1.5 shadow-3xs">
            ...
            <div class="sticky bottom-4 z-40 bg-white/95 backdrop-blur-md border border-zinc-200 px-5 py-3.5 rounded-2xl flex items-center justify-between flex-wrap gap-4 select-none shadow-xl transition-all">
                <div class="text-[11px] text-zinc-500 font-medium flex items-center gap-2">
                    ...
                    <span>Shipment Channel: <strong class="text-zinc-800 ">Production Stable (GitHub)</strong></span>
                </div>
                
                <div class="flex items-center gap-2">
                    <!-- Check Button -->
                    <button type="button" id="cora-btn-updates-check" class="px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-white font-bold rounded-xl text-xs transition-all cursor-pointer flex items-center gap-1.5 shadow-sm active:scale-97 select-none" onclick="coraCheckForUpdatesManual()">
            ...
            function coraRenderSettingsUpdateTimeline() {
                ...
                releases.forEach((rel, rIdx) => {
                    ...
                    html += `
                        <div class="cora-update-card-accordion border border-zinc-200 rounded-xl bg-white overflow-hidden shadow-3xs">
                            <!-- Version Card Header -->
                            <div class="p-3 bg-zinc-50/80 hover:bg-zinc-100/70 flex items-center justify-between cursor-pointer select-none" onclick="coraToggleVersionCard('${rIdx}')">
                                <div class="flex items-center gap-2.5 min-w-0 pr-2">
                                    <span class="px-2 py-0.5 rounded text-xs font-mono font-bold bg-zinc-900 text-white shrink-0">v${rel.version}</span>
                                    ${isLatest ? '<span class="px-2 py-0.5 rounded text-[9px] font-extrabold uppercase tracking-wide bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 shrink-0">LATEST</span>' : ''}
                                    <span class="text-xs font-bold text-zinc-800 truncate">${mainTitle}</span>
                                </div>
                                <div class="flex items-center gap-2 shrink-0">
                                    <span class="text-[10px] font-semibold text-zinc-400 ">${rel.items.length} ${rel.items.length === 1 ? 'change' : 'changes'}</span>
                            ...
                            <div class="cora-update-accordion-content ${isLatest ? 'open' : ''}" id="content-ver-${rIdx}">
                                <div class="p-4 space-y-3 bg-white border-t border-zinc-150 ">
                    `;

                    rel.items.forEach((item) => {
                        let svgIcon = `<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="1.8" fill="none" class="text-zinc-500 "><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>`;
                        ...
                        html += `
                            <div class="flex items-start gap-2.5 text-xs leading-relaxed">
                                <div class="w-6 h-6 rounded bg-zinc-50 flex items-center justify-center shrink-0 mt-0.5 border border-zinc-200/60 ">
                                    ${svgIcon}
                                </div>
                                <div class="flex-1">
                                    <strong class="font-bold text-zinc-900 mr-1">${item.title}:</strong>
            ...
            <div id="cora-update-confirm-modal" class="fixed inset-0 bg-zinc-950/40 backdrop-blur-xs z-50 flex items-center justify-center hidden opacity-0 transition-opacity duration-200 select-none">
                <div class="bg-white border border-zinc-200 rounded-2xl max-w-sm w-full p-6 shadow-xl transform scale-95 transition-transform duration-200 space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="space-y-1">
                            <h3 class="text-sm font-bold text-zinc-900 m-0">Upgrade Workspace</h3>
                            <p class="text-xs text-zinc-500 m-0 leading-normal">Are you sure you want to upgrade Cora Workspace to the latest version? The screen will automatically reload once the shipment is installed.</p>
                        </div>
                    </div>
                    <div class="flex items-center justify-end gap-2 pt-2">
                        <button type="button" id="cora-update-confirm-cancel" class="px-3.5 py-2 border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-700 font-bold rounded-xl text-xs transition-all cursor-pointer" onclick="closeCoraUpdateConfirmModal()">
                            Cancel
                        </button>
            ...
            <div class="relative w-full max-w-sm mx-4 mb-4 sm:mb-0 bg-white border border-zinc-200 rounded-2xl shadow-2xl overflow-hidden" style="animation: slideUpFade 0.18s ease;">
                <div class="p-5">
                    <div class="flex items-start gap-3 mb-4">
                        <div id="cora-confirm-icon-wrap" class="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 bg-zinc-100 ">
                            <svg id="cora-confirm-icon" viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2" fill="none" class="text-zinc-600 "><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                        </div>
                        <div>
                            <p class="text-sm font-bold text-zinc-900 m-0" id="cora-confirm-title">Confirm Action</p>
                            <p class="text-xs text-zinc-500 mt-1 leading-relaxed" id="cora-confirm-message"></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2.5">
                        <button type="button" id="cora-confirm-cancel" class="flex-1 py-2 text-xs font-semibold text-zinc-700 bg-zinc-100 hover:bg-zinc-200 rounded-xl transition-all cursor-pointer">Cancel</button>
                        <button type="button" id="cora-confirm-ok" class="flex-1 py-2 text-xs font-bold text-white bg-zinc-900 hover:bg-zinc-700 rounded-xl transition-all cursor-pointer" id="cora-confirm-ok">Confirm</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative w-full max-w-sm mx-4 mb-4 sm:mb-0 bg-white border border-zinc-200 rounded-2xl shadow-2xl overflow-hidden" style="animation: slideUpFade 0.18s ease;">
                <div class="p-5">
                    <div class="flex items-start gap-3 mb-3">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 bg-zinc-100 ">
                            <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2" fill="none" class="text-zinc-600 "><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                        </div>
                        <div>
                            <p class="text-sm font-bold text-zinc-900 m-0" id="cora-prompt-title">Input Required</p>
                            <p class="text-xs text-zinc-500 mt-1 leading-relaxed" id="cora-prompt-message"></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-2.5">
                        <button type="button" id="cora-prompt-cancel" class="flex-1 py-2 text-xs font-semibold text-zinc-700 bg-zinc-100 hover:bg-zinc-200 rounded-xl transition-all cursor-pointer">Cancel</button>
                        <button type="button" id="cora-prompt-ok" class="flex-1 py-2 text-xs font-bold text-white bg-zinc-900 hover:bg-zinc-700 rounded-xl transition-all cursor-pointer">Submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        window.coraConfirm = function(opts, onConfirm) {
            ...
            if (opts.danger) {
                ...
                okBtn.className = 'flex-1 py-2 text-xs font-bold text-white bg-zinc-900 hover:bg-zinc-700 rounded-xl transition-all cursor-pointer';
            }
        ...
        window.coraPrompt = function(opts, onSubmit) {
            ...
            if (opts.type === 'select') {
                ...
                input.className = 'w-full border border-zinc-200 rounded-xl px-2.5 py-1.5 text-xs text-zinc-700 bg-white outline-none';
