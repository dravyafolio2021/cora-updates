 ...
 * TypeScript definition for Next.js frontend and marketing components
 */

export const CORA_DESIGN_TOKENS = {
  version: "4.0.0",
  palette: {
    neutral: {
      50: "#fafafa",
...
export type CoraDesignTokensType = typeof CORA_DESIGN_TOKENS;
