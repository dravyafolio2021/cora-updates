              ...
              <div className="w-full max-w-[1240px] mx-auto rounded-[28px] bg-white border border-zinc-200/90 shadow-[0px_25px_70px_rgba(0,0,0,0.12)] p-8 sm:p-10 animate-in fade-in slide-in-from-top-3 duration-200">
                ...
                {activeDropdown === 'resources' && (
                  <div className="grid grid-cols-3 gap-6 items-stretch">
                    ...
                    {/* Card 1: Free Public Tools (Soft Periwinkle / Lavender Gradient) */}
                    <Link
                      href="/tools"
                      onClick={() => setActiveDropdown(null)}
                      className="group relative rounded-[26px] bg-gradient-to-b from-[#E0E7FF] via-[#EEF2FF] to-[#F5F3FF] border border-[#C7D2FE]/70 p-6 flex flex-col justify-between overflow-hidden shadow-xs hover:shadow-md hover:-translate-y-1 transition-all"
                    >
                      ...
                      <div className="bg-white/95 rounded-2xl p-3.5 border border-zinc-200/80 shadow-[0_6px_20px_rgba(0,0,0,0.06)] space-y-2 group-hover:scale-[1.02] transition-transform">
                    ...
                    {/* Card 2: Guides & Playbooks (Sky Blue Watercolor Gradient) */}
                    <Link
                      href="/features#esign-vault"
                      onClick={() => setActiveDropdown(null)}
                      className="group relative rounded-[26px] bg-gradient-to-b from-[#BAE6FD] via-[#E0F2FE] to-[#F0F9FF] border border-[#7DD3FC]/70 p-6 flex flex-col justify-between overflow-hidden shadow-xs hover:shadow-md hover:-translate-y-1 transition-all"
                    >
                      <div className="text-center space-y-1 mb-4">
                        <h3 className="font-display text-xl font-bold text-zinc-950">
                          Guides &amp; Playbooks
                    ...
                    {/* Card 3: Articles & Market Comparisons (Soft Mint Green Gradient) */}
                    <Link
                      href="/compare"
                      onClick={() => setActiveDropdown(null)}
                      className="group relative rounded-[26px] bg-gradient-to-b from-[#DCFCE7] via-[#F0FDF4] to-[#F0FDF4] border border-[#86EFAC]/70 p-6 flex flex-col justify-between overflow-hidden shadow-xs hover:shadow-md hover:-translate-y-1 transition-all"
                    >
                      <div className="text-center space-y-1 mb-4">
                        <h3 className="font-display text-xl font-bold text-zinc-950">
                          Articles &amp; Compare
