...
export function IndustryCard({ workspace, onOpenDetails }: IndustryCardProps) {
  return (
    <div className="group relative rounded-3xl bg-white border border-zinc-200/90 hover:border-zinc-400/90 overflow-hidden flex flex-col justify-between shadow-2xs hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-300">
      ...
      <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-3.5">
            <div className="flex items-center gap-2">
              <div className={`w-8 h-8 rounded-xl ${workspace.accentBg} ${workspace.accentText} border ${workspace.accentBorder} flex items-center justify-center shrink-0 shadow-2xs group-hover:scale-105 transition-transform`}>
                <IndustryIcon name={workspace.iconName} className="w-4 h-4" />
              </div>
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-zinc-600 bg-zinc-100 px-2.5 py-1 rounded-full border border-zinc-200/80">
        ...
        {/* Bottom Actions */}
        <div className="pt-5 mt-6 border-t border-zinc-100 flex items-center justify-between gap-3">
          <Link
