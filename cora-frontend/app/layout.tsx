...
export const metadata: Metadata = {
  title: 'Cora — The AI Co-Founder for Agencies',
  description: 'Meet Cora (Co-founder for Operations, Revenue & Automation). The autonomous AI co-founder for agencies and service businesses—running proposals, SHA-256 contracts, 18% GST invoices, crew dispatch, and client delivery on autopilot.',
  keywords: [
    'Cora',
    'HeyCora',
    'Cora AI',
    'Cora AI co-founder',
    'AI co-founder for agencies',
    'agency operating system',
    'creative agency management software',
    'AI cofounder for service businesses',
    'operations revenue automation',
    'HoneyBook alternative for agencies',
    'Studio Ninja alternative',
    'DocuSign alternative India',
    '18% GST invoice generator for agencies',
    'SHA-256 digital signature software India',
    'agency retainer billing software',
  ...
  openGraph: {
    title: 'Cora — The AI Co-Founder for Agencies',
    description: 'Meet Cora (Co-founder for Operations, Revenue & Automation). The autonomous AI co-founder for agencies and service businesses.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Cora — The AI Co-Founder for Agencies',
      },
    ],
    type: 'website',
  },
