  ...
  return (
    <main className="w-full relative pb-24 overflow-hidden bg-white text-zinc-900">
      ...
      <section className="w-full max-w-[1240px] mx-auto px-4 sm:px-6 mb-16">
        ...
        {/* ══════════════════════════════════════════════════════════════════════
            ACCORDION COMPARISON MATRIX (EXPANDS RIGHT HERE UNDER THE BUTTON)
        ══════════════════════════════════════════════════════════════════════ */}
        {showComparison && (
          <div className="mt-10 border border-zinc-200/90 rounded-3xl overflow-hidden shadow-sm bg-white animate-in fade-in slide-in-from-top-3 duration-200">
